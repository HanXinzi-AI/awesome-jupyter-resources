...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 570 · 🔀 3.5K · 📥 3.2K · 📦 130K · 📋 4.3K - 46% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/jupyter/notebook
	```
- [PyPi](https://pypi.org/project/notebook) (📥 7.6M / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab">JupyterLab</a></b> (🥇34 ·  ⭐ 12K) - JupyterLab computational environment. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyterlab/jupyterlab) (👨‍💻 460 · 🔀 2.1K · 📥 17K · 📦 53K · 📋 6.2K - 30% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 260 · 🔀 1.6K · 📦 1.6K · 📋 2K - 8% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 210 · 🔀 2.4K · 📋 710 - 10% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 170 · 🔀 520 · 📥 1.3M · 📋 1.7K - 9% open · ⏱️ 03.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter):
	```
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 140 · 🔀 760 · 📋 280 - 3% open · ⏱️ 07.12.2021):
...
<details><summary><b><a href="https://github.com/googledatalab/datalab">DataLab</a></b> (🥉18 ·  ⭐ 960 · 📉) - Interactive tools and developer experiences for Big Data on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/googledatalab/datalab) (👨‍💻 52 · 🔀 240 · 📋 890 - 25% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/datalab):
	```
	pip install datalab
	```
</details>
...
- [GitHub](https://github.com/ml-tooling/ml-hub) (👨‍💻 6 · 🔀 44 · 📥 1.7K · 📋 22 - 59% open · ⏱️ 02.10.2020):
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 180 · 🔀 760 · 📦 2.8K · 📋 1.7K - 31% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/jupyter-widgets/ipywidgets
	```
- [PyPi](https://pypi.org/project/ipywidgets) (📥 7.1M / month):
	```
...
<details><summary><b><a href="https://github.com/pandas-profiling/pandas-profiling">pandas-profiling</a></b> (🥇30 ·  ⭐ 8.3K) - Create HTML profiling reports from pandas DataFrame.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 71 · 🔀 290 · 📦 1.3K · 📋 450 - 38% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 31K / month):
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 25 · 🔀 170 · 📦 2.2K · 📋 220 - 42% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 40K / month):
	```
	pip install ipympl
	```
...
- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 28 · 🔀 820 · 📦 91 · 📋 150 - 50% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 90K / month):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 18 · 🔀 220 · 📦 270 · 📋 440 - 8% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/man-group/dtale
	```
- [PyPi](https://pypi.org/project/dtale) (📥 22K / month):
	```
	pip install dtale
	```
- [Conda](https://anaconda.org/conda-forge/dtale) (📥 99K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 3 · 🔀 170 · 📥 65 · 📦 1.1K · 📋 47 - 68% open · ⏱️ 22.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 24K / month):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 14 · 🔀 40 · 📦 320 · 📋 95 - 34% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/martinRenou/ipycanvas
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/cytoscape/ipycytoscape) (👨‍💻 29 · 🔀 46 · 📥 3 · 📦 54 · 📋 140 - 38% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/quantopian/qgrid) (👨‍💻 30 · 🔀 370 · 📦 1 · 📋 270 - 53% open · ⏱️ 07.04.2020):

	```
	git clone https://github.com/quantopian/qgrid
	```
- [PyPi](https://pypi.org/project/qgrid) (📥 27K / month):
	```
	pip install qgrid
	```
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 330K · ⏱️ 04.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 690 / month):
	```
	npm install qgrid
	```
</details>
...
<details><summary><b><a href="https://github.com/mariobuikhuizen/ipyvuetify">ipyvuetify</a></b> (🥈20 ·  ⭐ 230) - Jupyter widgets based on vuetify UI components. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mariobuikhuizen/ipyvuetify) (👨‍💻 10 · 🔀 38 · 📦 4 · 📋 140 - 23% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/mariobuikhuizen/ipyvuetify
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 23K / month):
	```
...
<details><summary><b><a href="https://github.com/PAIR-code/what-if-tool">What-If Tool</a></b> (🥈19 ·  ⭐ 610) - Source code/webpage/demos for the What-If Tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/nicolaskruchten/jupyter_pivottablejs) (👨‍💻 3 · 🔀 61 · 📦 200 · 📋 56 - 28% open · ⏱️ 04.12.2018):

	```
	git clone https://github.com/nicolaskruchten/jupyter_pivottablejs
	```
- [PyPi](https://pypi.org/project/pivottablejs) (📥 8.4K / month):
	```
...
- [GitHub](https://github.com/mariobuikhuizen/ipyvue) (👨‍💻 3 · 🔀 10 · 📦 16 · 📋 6 - 50% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 23K / month):
	```
	pip install ipyvue
	```
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 7 · 📋 6 - 33% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 81K / month):
	```
...
<details><summary><b><a href="https://github.com/timkpaine/ipydagred3">ipydagred3</a></b> (🥉17 ·  ⭐ 28) - ipywidgets library for drawing directed acyclic graphs in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 3 · 🔀 5 · 📦 8 · 📋 19 - 26% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 410 · 📋 9 - 44% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 22K / month):
	```
...
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥉16 ·  ⭐ 220 · 💤) - Interactive Tables in Jupyter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jpmorganchase/ipyregulartable">ipyregulartable</a></b> (🥉16 ·  ⭐ 50) - High performance, editable, stylable datagrids in jupyter.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jpmorganchase/ipyregulartable) (👨‍💻 4 · 🔀 9 · 📦 8 · 📋 24 - 37% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 27 / month):
	```
...
- [GitHub](https://github.com/vidartf/ipyscales) (👨‍💻 4 · 🔀 3 · 📦 48 · 📋 6 - 33% open · ⏱️ 05.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyscales) (📥 47 / month):
	```
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 8 · 🔀 150 · 📦 22 · 📋 57 - 56% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/QuantStack/ipytree) (👨‍💻 8 · 🔀 23 · 📋 28 - 53% open · ⏱️ 10.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 6.1K / month):
	```
	pip install ipytree
	```
...
<details><summary><b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉15 ·  ⭐ 70 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/nipy/niwidgets) (👨‍💻 16 · 🔀 33 · 📦 27 · 📋 34 - 50% open · ⏱️ 24.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/niwidgets) (📥 92 / month):
	```
...
<details><summary><b><a href="https://github.com/spacetelescope/jdaviz">jdaviz</a></b> (🥉13 ·  ⭐ 33) - JWST astronomical data analysis tools in the Jupyter platform. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 24 · 🔀 25 · 📋 470 - 46% open · ⏱️ 08.12.2021):
...
- [PyPi](https://pypi.org/project/ipymaterialui):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-materialui) (📥 94 / month):
	```
...
- [GitHub](https://github.com/leifwalsh/perfume) (👨‍💻 3 · 🔀 3 · 📋 6 - 33% open · ⏱️ 31.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/perfume-bench) (📥 25 / month):
	```
...
- [PyPi](https://pypi.org/project/ipysigma):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 14 / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 3 · 🔀 10 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 36 / month):
	```
...
- [GitHub](https://github.com/jtpio/ipyp5) (👨‍💻 2 · 🔀 4 · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyp5) (📥 11 / month):
	```
	pip install ipyp5
	```
</details>
<details><summary><b><a href="https://github.com/DGothrek/ipyaggrid">ipyaggrid</a></b> (🥉8 ·  ⭐ 8 · 💀) - Jupyter widget - ag-grid in the notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/ipyaggrid):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 860 / month):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 130 · 🔀 740 · 📋 760 - 40% open · ⏱️ 06.04.2021):

	```
	git clone https://github.com/ipython-contrib/jupyter_contrib_nbextensions
	```
- [PyPi](https://pypi.org/project/jupyter_contrib_nbextensions) (📥 150K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 84 · 🔀 260 · 📋 780 - 25% open · ⏱️ 03.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 1.8K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/nbgitpuller">nbgitpuller</a></b> (🥈19 ·  ⭐ 150) - Jupyter server extension to sync a git repository one-way to a.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 23 · 🔀 52 · 📦 400 · 📋 110 - 40% open · ⏱️ 16.11.2021):
...
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-server-proxy">jupyter-server-proxy</a></b> (🥈18 ·  ⭐ 200) - Jupyter notebook server extension to proxy web services. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 60 · 🔀 98 · 📦 1 · 📋 150 - 37% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/jupyterhub/jupyter-server-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 41K / month):
	```
...
<details><summary><b><a href="https://github.com/dunovank/jupyter-themes">Jupyter Themes</a></b> (🥈17 ·  ⭐ 8.9K) - Custom Jupyter Notebook Themes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/8080labs/pyforest) (👨‍💻 13 · 🔀 170 · 📋 22 - 36% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyforest) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/Jupyter-contrib/jupyter_nbextensions_configurator) (👨‍💻 17 · 🔀 98 · 📋 79 - 59% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_nbextensions_configurator) (📥 150K / month):
	```
...
- [GitHub](https://github.com/mozilla/jupyter-spark) (👨‍💻 12 · 🔀 30 · 📦 15 · 📋 27 - 48% open · ⏱️ 01.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-spark) (📥 530 / month):
	```
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 15 · 📦 240 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 400 / month):
	```
	pip install nbzip
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-rsession-proxy">Rsession Proxy</a></b> (🥉14 ·  ⭐ 81) - Jupyter extensions for running an RStudio rsession proxy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 18 · 🔀 59 · 📦 30 · 📋 64 - 34% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/paypal/PPExtensions) (👨‍💻 9 · 🔀 27 · 📦 1 · 📋 38 - 42% open · ⏱️ 07.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/ppextensions) (📥 34 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter-incubator/sparkmagic">sparkmagic</a></b> (🥇25 ·  ⭐ 1.1K) - Jupyter magics and kernels for working with remote Spark.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 54 · 🔀 360 · 📦 220 · 📋 380 - 32% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sparkmagic) (📥 31K / month):
	```
...
- [GitHub](https://github.com/rasbt/watermark) (👨‍💻 15 · 🔀 71 · 📦 1.3K · 📋 41 - 36% open · ⏱️ 18.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/watermark) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/ShopRunner/jupyter-notify) (👨‍💻 11 · 🔀 31 · 📋 22 - 50% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyternotify) (📥 610 / month):
	```
	pip install jupyternotify
	```
</details>
<details><summary><b><a href="https://github.com/csurfer/pyheatmagic">heat</a></b> (🥉13 ·  ⭐ 960) - IPython magic command to profile and view your python code as a heat map. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/csurfer/pyheatmagic) (👨‍💻 3 · 🔀 21 · 📦 24 · 📋 5 - 40% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat-magic):
	```
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 21K / month):
	```
	pip install pick
	```
</details>
...
<details><summary><b><a href="https://github.com/ipython/ipykernel">IPython Kernel</a></b> (🥇32 ·  ⭐ 440) - IPython Kernel for Jupyter. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 280 · 📥 120 · 📦 140K · 📋 360 - 51% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 17 · 🔀 57 · 📥 4 · 📋 160 - 17% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/calysto/octave_kernel
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 9.1K / month):
	```
...
- [GitHub](https://github.com/apache/incubator-toree) (👨‍💻 100 · 🔀 210 · ⏱️ 07.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/toree) (📥 4.5K / month):
	```
	pip install toree
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyter/enterprise_gateway">Enterprise Gateway</a></b> (🥈19 ·  ⭐ 480) - A lightweight, multi-tenant, scalable and secure.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyter/enterprise_gateway) (👨‍💻 86 · 🔀 150 · 📥 12K · 📋 490 - 18% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_enterprise_gateway) (📥 510 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/kernel_gateway">Kernel Gateway</a></b> (🥈18 ·  ⭐ 370) - Jupyter Kernel Gateway. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyter/kernel_gateway) (👨‍💻 44 · 🔀 110 · 📥 100 · 📋 180 - 8% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/gibiansky/IHaskell) (👨‍💻 100 · 🔀 230 · 📋 720 - 3% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 71 · 📋 55 - 5% open · ⏱️ 21.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 350 / month):
	```
...
- [GitHub](https://github.com/clojupyter/clojupyter) (👨‍💻 26 · 🔀 74 · 📋 92 - 21% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/ansible/ansible-jupyter-kernel) (👨‍💻 9 · 🔀 48 · 📦 8 · 📋 41 - 29% open · ⏱️ 05.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ansible-kernel) (📥 94 / month):
	```
...
- [GitHub](https://github.com/fsprojects/IfSharp) (👨‍💻 27 · 🔀 66 · 📥 5.3K · 📋 140 - 10% open · ⏱️ 10.09.2020):
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 20 · 🔀 15 · ⏱️ 05.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/lfortran) (📥 66 / month):
	```
...
- [GitHub](https://github.com/takluyver/bash_kernel) (👨‍💻 13 · 🔀 99 · 📥 2.8K · 📋 90 - 41% open · ⏱️ 22.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/bash_kernel) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/Calysto/matlab_kernel) (👨‍💻 17 · 🔀 72 · 📋 130 - 19% open · ⏱️ 09.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 770 / month):
	```
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 10 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 110 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 240 · 🔀 450 · 📦 130K · 📋 940 - 41% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/jupyter/nbconvert
	```
- [PyPi](https://pypi.org/project/nbconvert) (📥 8.1M / month):
	```
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 330 · 📦 390 · 📋 2.1K - 1% open · ⏱️ 26.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/nikola) (📥 920 / month):
	```
	pip install nikola
	```
</details>
<details><summary><b><a href="https://github.com/mwouts/jupytext">Jupytext</a></b> (🥇26 ·  ⭐ 5K) - Jupyter Notebooks as Markdown Documents, Julia, Python or R scripts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 67 · 🔀 300 · 📦 2.2K · 📋 480 - 15% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 56 · 🔀 360 · 📥 95 · 📦 5.4K · 📋 550 - 41% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 18K / month):
	```
	pip install voila
	```
...
- [GitHub](https://github.com/damianavila/RISE) (👨‍💻 40 · 🔀 360 · 📦 1.7K · 📋 410 - 32% open · ⏱️ 26.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/RISE) (📥 4.3K / month):
	```
	pip install RISE
	```
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 34 · 🔀 120 · 📦 62 · 📋 280 - 21% open · ⏱️ 03.11.2021):

	```
	git clone https://github.com/jupyter/nbdime
	```
- [PyPi](https://pypi.org/project/nbdime) (📥 120K / month):
	```
	pip install nbdime
	```
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 420K · ⏱️ 26.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 91K / month):
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 26 · 🔀 32 · 📥 920 · 📦 16 · 📋 540 - 9% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 60 · 🔀 620 · 📋 280 - 41% open · ⏱️ 01.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/knowledge-repo) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 95 · 🔀 390 · 📋 960 - 38% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/nteract/bookstore) (👨‍💻 7 · 🔀 18 · 📦 5 · 📋 73 - 46% open · ⏱️ 09.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/bookstore) (📥 80K / month):
	```
...
- [GitHub](https://github.com/aaren/notedown) (👨‍💻 7 · 🔀 92 · 📦 150 · 📋 68 - 57% open · ⏱️ 16.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/notedown):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 63 · 📦 3 · 📋 90 - 56% open · ⏱️ 17.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 180 / month):
	```
...
<details><summary><b><a href="https://github.com/nteract/scrapbook">scrapbook</a></b> (🥉13 ·  ⭐ 230 · 💤) - A library for recording and reading data in notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 23 · 📦 78 · 📋 48 - 47% open · ⏱️ 28.04.2021):

	```
	git clone https://github.com/nteract/scrapbook
	```
- [PyPi](https://pypi.org/project/nteract-scrapbook):
	```
	pip install nteract-scrapbook
	```
</details>
<details><summary><b><a href="https://github.com/ideonate/cdsdashboards">cdsdashboards</a></b> (🥉13 ·  ⭐ 150) - JupyterHub extension for ContainDS Dashboards. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b> (🥉13 ·  ⭐ 87) - Use Jupyter Notebook in mkdocs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 9 · 🔀 11 · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 9.7K / month):
	```
	pip install mkdocs-jupyter
	```
</details>
<details><summary><b><a href="https://github.com/SamLau95/nbinteract">nbinteract</a></b> (🥉12 ·  ⭐ 210 · 💤) - Create interactive webpages from Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 58 · 🔀 120 · 📦 130K · 📋 110 - 41% open · ⏱️ 10.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 8.1M / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥇28 ·  ⭐ 82) - A client library for executing notebooks. Formally nbconvert's.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 28 · 🔀 39 · 📥 5 · 📦 37K · 📋 72 - 30% open · ⏱️ 05.12.2021):

	```
	git clone https://github.com/jupyter/nbclient
	```
- [PyPi](https://pypi.org/project/nbclient) (📥 7.7M / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 110 · 🔀 210 · 📥 100 · 📋 290 - 42% open · ⏱️ 05.12.2021):

	```
	git clone https://github.com/jupyter/jupyter_client
	```
- [PyPi](https://pypi.org/project/jupyter-client) (📥 8M / month):
	```
...
- [GitHub](https://github.com/pixiedust/pixiedust) (👨‍💻 33 · 🔀 160 · 📦 220 · 📋 420 - 38% open · ⏱️ 16.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pixiedust) (📥 8.6K / month):
	```
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 100 · 🔀 810 · 📦 1.7K · 📋 310 - 14% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/ipython/ipyparallel
	```
- [PyPi](https://pypi.org/project/ipyparallel) (📥 31K / month):
	```
...
<details><summary><b><a href="https://github.com/computationalmodelling/nbval">nbval</a></b> (🥈22 ·  ⭐ 360 · 💤) - A py.test plugin to validate Jupyter notebooks. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 27 · 🔀 40 · 📦 1.2K · 📋 95 - 36% open · ⏱️ 27.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbval) (📥 42K / month):
	```
	pip install nbval
	```
...
<details><summary><b><a href="https://github.com/fastai/nbdev">nbdev</a></b> (🥈20 ·  ⭐ 3.1K · 📉) - Create delightful python projects using Jupyter Notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jupyter/jupyter-sphinx) (👨‍💻 24 · 🔀 46 · 📋 110 - 31% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_sphinx) (📥 35K / month):
	```
	pip install jupyter_sphinx
	```
</details>
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥉17 ·  ⭐ 370) - Run any standard Python code quality tool on a Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 17 · 🔀 22 · 📋 240 - 1% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 18 · 📦 35 · 📋 11 - 18% open · ⏱️ 08.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 2.4K / month):
	```
	pip install treon
	```
</details>
<details><summary><b><a href="https://github.com/QuantEcon/sphinxcontrib-jupyter">sphinxcontrib.jupyter</a></b> (🥉15 ·  ⭐ 72 · 💀) - A Sphinx Extension for Generating Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 13 · 🔀 11 · 📦 3 · 📋 120 - 66% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/naas) (📥 3.7K / month):
	```
	pip install naas
	```
</details>
...
- [GitHub](https://github.com/takluyver/jupyter_kernel_mgmt) (👨‍💻 74 · 🔀 7 · 📥 17 · 📋 24 - 41% open · ⏱️ 29.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-mgmt) (📥 30 / month):
	```
...
- [GitHub](https://github.com/stas00/ipyexperiments) (👨‍💻 3 · 🔀 10 · 📦 5 · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyexperiments) (📥 80 / month):
	```
...
<details><summary><b><a href="https://github.com/Invictify/Jupter-Notebook-REST-API">Jupter-Notebook-REST-API</a></b> (🥉7 ·  ⭐ 36 · 💀) - Run your jupyter notebooks as a REST API endpoint... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab_latex):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/latex) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 56 · 📦 160 · 📋 64 - 60% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 23 · 🔀 59 · 📦 1 · 📋 100 - 31% open · ⏱️ 31.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 8.7K / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 32 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 81 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 18 · 📦 140 · 📋 21 - 23% open · ⏱️ 26.08.2021):

	```
	git clone https://github.com/telamonian/theme-darcula
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 3.1K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-solarized-dark) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/Rahlir/theme-gruvbox) (👨‍💻 3 · 🔀 9 · ⏱️ 12.04.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@rahlir/theme-gruvbox) (📥 150 / month):
	```
...
- [GitHub](https://github.com/kenshohara/theme-nord-extension) (🔀 1 · 📋 5 - 20% open · ⏱️ 20.09.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@kenshohara/theme-nord-extension) (📥 27 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-git) (👨‍💻 68 · 🔀 200 · 📦 14 · 📋 500 - 16% open · ⏱️ 13.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-git) (📥 71K / month):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 38 · 🔀 81 · 📦 93 · 📋 370 - 34% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 65 · 🔀 410 · 📦 220 · 📋 470 - 12% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 1.5K / month):
	```
...
<details><summary><b><a href="https://github.com/elyra-ai/elyra">elyra</a></b> (🥇23 ·  ⭐ 1.2K) - Elyra extends JupyterLab Notebooks with an AI centric approach. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 38 · 🔀 190 · 📦 27 · 📋 1.3K - 18% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/elyra-ai/elyra
	```
- [PyPi](https://pypi.org/project/elyra) (📥 870 / month):
	```
	pip install elyra
	```
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 36 · 📦 120 · 📋 260 - 6% open · ⏱️ 31.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 95K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 14 · 🔀 100 · 📦 140 · 📋 120 - 55% open · ⏱️ 10.08.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-github) (👨‍💻 14 · 🔀 78 · 📦 2 · 📋 57 - 36% open · ⏱️ 03.12.2021):
...
- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 30 · 🔀 39 · 📋 140 - 15% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 9.5K / month):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 15 · 🔀 52 · 📋 51 - 45% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 1.8K / month):
	```
	pip install jupyterlab-nvdashboard
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 7.8K / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 49 · 📦 4 · 📋 78 - 11% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 2K / month):
	```
...
- [GitHub](https://github.com/dask/dask-labextension) (👨‍💻 18 · 🔀 44 · 📋 120 - 29% open · ⏱️ 05.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/dask-labextension) (📥 2.6K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/dask-labextension) (📥 490K · ⏱️ 16.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/dask-labextension) (📥 5K / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/jupyterlab-sidecar) (👨‍💻 13 · 🔀 35 · 📦 3 · 📋 29 - 65% open · ⏱️ 04.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sidecar) (📥 750 / month):
	```
	pip install sidecar
	```
...
- [GitHub](https://github.com/jwkvam/jupyterlab-vim) (👨‍💻 8 · 🔀 70 · 📦 3 · 📋 96 - 56% open · ⏱️ 16.07.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_vim) (📥 600 / month):
	```
...
- [GitHub](https://github.com/krassowski/jupyterlab-go-to-definition) (👨‍💻 2 · 🔀 9 · 📦 11 · 📋 23 - 43% open · ⏱️ 28.07.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab_go_to_definition) (📥 4K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-data-explorer) (👨‍💻 9 · 🔀 34 · 📦 10 · 📋 91 - 62% open · ⏱️ 24.05.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/dataregistry-extension) (📥 110 / month):
	```
	npm install @jupyterlab/dataregistry-extension
	```
</details>
<details><summary><b><a href="https://github.com/timkpaine/jupyterlab_iframe">JupyterLab IFrame</a></b> (🥈16 ·  ⭐ 75) - JupyterLab iframe widget. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 15 · 📦 3 · 📋 63 - 7% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 310 / month):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 10 · 🔀 24 · 📋 26 - 7% open · ⏱️ 01.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-execute-time) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-celltags) (👨‍💻 10 · 🔀 25 · 📦 320 · 📋 18 - 61% open · ⏱️ 29.04.2020):
...
- [GitHub](https://github.com/pbugnion/jupyterlab-sql) (👨‍💻 2 · 🔀 42 · 📋 74 - 50% open · ⏱️ 04.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_sql) (📥 430 / month):
	```
...
- [GitHub](https://github.com/chaoleili/jupyterlab_tensorboard) (👨‍💻 6 · 🔀 27 · 📦 2 · 📋 26 - 61% open · ⏱️ 24.02.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_tensorboard) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 16 · 🔀 35 · 📋 79 - 11% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh):
	```
	pip install jupyter-bokeh
	```
- [NPM](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 29K / month):
	```
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 5 · 🔀 4 · 📥 18 · 📋 25 - 32% open · ⏱️ 14.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 530 / month):
	```
	pip install ipylab
	```
...
- [GitHub](https://github.com/parente/jupyterlab-quickopen) (👨‍💻 5 · 🔀 6 · ⏱️ 14.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 240 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 4 · 🔀 7 · 📦 3 · 📋 13 - 15% open · ⏱️ 01.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 210 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 8 · 🔀 15 · 📋 13 - 53% open · ⏱️ 17.01.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 400 / month):
	```
...
- [GitHub](https://github.com/microsoft/gather) (👨‍💻 12 · 🔀 27 · 📋 26 - 38% open · ⏱️ 14.02.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 56 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-commenting) (👨‍💻 10 · 🔀 22 · 📋 34 - 70% open · ⏱️ 01.05.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/commenting-extension) (📥 170 / month):
	```
...
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉13 ·  ⭐ 65) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 9 · 🔀 15 · 📋 15 - 46% open · ⏱️ 04.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 200 / month):
	```
	pip install jupyterlab-sparkmonitor
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/nbcelltests):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_celltests) (📥 79 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 36 - 16% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 32 / month):
	```
	pip install jupyterlab_email
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_email) (📥 350 / month):
	```
...
<details><summary><b><a href="https://github.com/jpmorganchase/jupyter-fs">jupyter-fs</a></b> (🥉10 ·  ⭐ 100) - A filesystem-like contents manager for multiple backends in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/timkpaine/knowledgelab) (👨‍💻 3 · 🔀 6 · 📦 2 · 📋 27 - 11% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/knowledgelab):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 92 / month):
	```
	npm install jupyterlab_spark
	```
</details>
<details><summary><b><a href="https://github.com/jtpio/jupyterlab-topbar">JupyterLab Top Bar</a></b> (🥉10 ·  ⭐ 2) - JupyterLab Top Bar extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 1 · ⏱️ 13.09.2021):
...
<details><summary><b><a href="https://github.com/jtpio/jupyterlab-python-bytecode">JupyterLab Bytecode</a></b> (🥉8 ·  ⭐ 57 · 💀) - JupyterLab extension to explore CPython Bytecode. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 📥 2 · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 76 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 30 · 🔀 150 · 📦 82 · 📋 130 - 40% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/jupyterhub/ldapauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-ldapauthenticator) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 11 · 🔀 36 · 📦 69 · 📋 31 - 16% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 51 · 📦 32 · 📋 89 - 23% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 2.8K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 21 · 📦 55 · 📋 22 - 22% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dummyauthenticator) (🔀 15 · 📦 92 · 📋 7 - 71% open · ⏱️ 12.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-dummyauthenticator) (📥 1.3K / month):
	```
...
- [GitHub](https://github.com/mogthesprog/jwtauthenticator) (👨‍💻 7 · 🔀 36 · 📦 8 · 📋 17 - 52% open · ⏱️ 13.02.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-jwtauthenticator) (📥 210 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 5 · 🔀 10 · 📦 70 · ⏱️ 09.02.2021):

	```
	git clone https://github.com/jupyterhub/nullauthenticator
	```
- [PyPi](https://pypi.org/project/nullauthenticator) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 6 · 🔀 16 · 📥 13 · 📋 28 - 50% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 180 / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 26 · 📋 16 - 43% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 370 / month):
	```
...
- [GitHub](https://github.com/ucphhpc/jhub-authenticators) (👨‍💻 5 · 🔀 1 · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jhub-authenticators) (📥 50 / month):
	```
...
- [GitHub](https://github.com/thedataincubator/jupyterhub-hashauthenticator) (👨‍💻 3 · 🔀 3 · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-hashauthenticator) (📥 23 / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_cas_authenticator) (👨‍💻 4 · 🔀 10 · 📋 11 - 9% open · ⏱️ 27.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/jhub_cas_authenticator) (📥 120 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kerberosauthenticator) (👨‍💻 2 · 🔀 5 · 📋 5 - 60% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kerberosauthenticator) (📥 31 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/dockerspawner">DockerSpawner</a></b> (🥇19 ·  ⭐ 400) - Spawns JupyterHub single user servers in Docker containers. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterhub/batchspawner">BatchSpawner</a></b> (🥈17 ·  ⭐ 130 · 💤) - Custom Spawner for Jupyterhub to start servers in batch.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterhub/kubespawner">KubeSpawner</a></b> (🥈16 ·  ⭐ 390 · 📉) - Kubernetes spawner for JupyterHub. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 66 · 🔀 220 · 📦 99 · 📋 270 - 18% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 17 · 🔀 38 · 📦 19 · 📋 54 - 46% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-systemdspawner) (📥 950 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 14 · 🔀 37 · 📦 35 · 📋 37 - 45% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 400 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 10 · 📋 9 - 55% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 850 · 🔀 4.1K · 📥 320K · 📦 240K · 📋 6.8K - 21% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/ipython/ipython
	```
- [PyPi](https://pypi.org/project/ipython) (📥 13M / month):
	```
	pip install ipython
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 450 · 🔀 140 · 📥 180 · 📋 220 - 29% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 22 · 🔀 38 · 📋 30 - 30% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 79 · 🔀 210 · 📦 2.4K · 📋 1.5K - 29% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 170K / month):
	```
	pip install panel
	```
...
<details><summary><b><a href="https://github.com/jupyter/qtconsole">qtconsole</a></b> (🥈29 ·  ⭐ 290) - Jupyter Qt Console. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 110 · 🔀 160 · 📦 89K · 📋 290 - 33% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/jupyter/qtconsole
	```
- [PyPi](https://pypi.org/project/qtconsole):
	```
...
- [GitHub](https://github.com/abhishekkrthakur/colabcode) (👨‍💻 8 · 🔀 220 · 📦 49 · 📋 61 - 50% open · ⏱️ 11.06.2021):

	```
	git clone https://github.com/abhishekkrthakur/colabcode
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 9.2K / month):
	```
