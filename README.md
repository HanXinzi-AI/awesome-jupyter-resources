...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 650 · 🔀 4.4K · 📥 17K · 📦 270K · 📋 4.8K - 39% open · ⏱️ 26.02.2024):

	```
	git clone https://github.com/jupyter/notebook
	```
- [PyPi](https://pypi.org/project/notebook) (📥 23M / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 360 · 🔀 1.9K · 📦 2.8K · 📋 2.4K - 6% open · ⏱️ 06.03.2024):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 540 · 📥 1.5M · 📦 3 · 📋 1.7K - 9% open · ⏱️ 30.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 1.2K / month):
	```
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 270 · 🔀 250 · 📦 3 · 📋 9.6K - 3% open · ⏱️ 07.03.2024):
...
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 400K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 380 / month):
	```
	npm install qgrid
	```
</details>
...
- [GitHub](https://github.com/jupyter-widgets-contrib/ipytree) (👨‍💻 9 · 🔀 29 · 📋 40 - 50% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 63K / month):
	```
	pip install ipytree
	```
...
<details><summary><b><a href="https://github.com/timkpaine/ipydagred3">ipydagred3</a></b> (🥉17 ·  ⭐ 67) - ipywidgets library for drawing directed acyclic graphs in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 21 · 📦 8 · ⏱️ 20.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 6.8K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 970 / month):
	```
...
<details><summary><b><a href="https://github.com/jtpio/ipyp5">ipyp5</a></b> (🥉8 ·  ⭐ 37 · 💀) - p5.js Jupyter Widget. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 71 · 🔀 130 · 📦 4 · 📋 190 - 32% open · ⏱️ 23.02.2024):
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyter-archive">jupyter-archive</a></b> (🥉17 ·  ⭐ 69) - A Jupyter/Jupyterlab extension to make, download and extract.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/paypal/PPExtensions) (👨‍💻 9 · 🔀 28 · 📦 1 · 📋 38 - 42% open · ⏱️ 07.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/ppextensions) (📥 67 / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 55 · 🔀 270 · 📦 6.1K · 📋 150 - 71% open · ⏱️ 21.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipython-sql) (📥 170K / month):
	```
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 64 · 🔀 410 · 📦 330 · 📋 430 - 30% open · ⏱️ 10.02.2024):
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 120K / month):
	```
	pip install pick
	```
</details>
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 20 · 🔀 64 · 📥 150 · 📦 71 · 📋 180 - 18% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/calysto/octave_kernel
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 9.6K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 120 · 🔀 200 · 📥 34K · 📋 560 - 12% open · ⏱️ 20.02.2024):
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 47 · 🔀 120 · 📥 150 · 📋 180 - 8% open · ⏱️ 29.02.2024):

	```
	git clone https://github.com/jupyter/kernel_gateway
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 21K / month):
	```
...
- [GitHub](https://github.com/Cadair/jupyter_environment_kernels) (👨‍💻 8 · 🔀 17 · 📦 5 · 📋 30 - 23% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/environment_kernels) (📥 24K / month):
	```
	pip install environment_kernels
	```
</details>
<details><summary><b><a href="https://github.com/lfortran/lfortran">LFortran</a></b> (🥉16 ·  ⭐ 840) - Official mirror of https://gitlab.com/lfortran/lfortran. Please.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 76 · 🔀 120 · 📥 780 · 📋 1.8K - 55% open · ⏱️ 06.03.2024):
...
<details><summary><b><a href="https://github.com/WolframResearch/WolframLanguageForJupyter">Wolfram Kernel</a></b> (🥉14 ·  ⭐ 950 · 💀) - Wolfram Language kernel for Jupyter notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 140 · 🔀 600 · 📦 13K · 📋 1.3K - 44% open · ⏱️ 08.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 88K / month):
	```
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 85 · 🔀 380 · 📦 6.9K · 📋 650 - 18% open · ⏱️ 13.01.2024):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 68 · 🔀 480 · 📥 1K · 📦 11K · 📋 710 - 39% open · ⏱️ 07.02.2024):
...
- [Conda](https://anaconda.org/conda-forge/voila) (📥 320K · ⏱️ 31.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 240 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbviewer) (👨‍💻 96 · 🔀 520 · 📦 17 · 📋 580 - 30% open · ⏱️ 27.01.2023):
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 43 · 🔀 43 · 📥 4.1K · 📦 20 · 📋 700 - 12% open · ⏱️ 07.03.2024):

	```
	git clone https://github.com/stencila/stencila
	```
- [NPM](https://www.npmjs.com/package/stencila) (📥 17 / month):
	```
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 27 · 📦 340 · 📋 50 - 48% open · ⏱️ 13.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/nteract-scrapbook) (📥 11K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/binderhub">BinderHub</a></b> (🥉15 ·  ⭐ 2.4K · 📉) - Run your code in the cloud, with technology so advanced, it.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 65 · 📦 2 · 📋 92 - 57% open · ⏱️ 28.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 51 / month):
	```
...
- [GitHub](https://github.com/ideonate/cdsdashboards) (👨‍💻 14 · 🔀 38 · 📋 93 - 36% open · ⏱️ 12.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cdsdashboards) (📥 620 / month):
	```
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 47 · 🔀 460 · 📋 850 - 15% open · ⏱️ 04.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 65K / month):
	```
	pip install nbdev
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyterhub/repo2docker">repo2docker</a></b> (🥈24 ·  ⭐ 1.6K) - Turn repositories into Jupyter-enabled Docker images. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 33 · 🔀 46 · 📦 2.9K · 📋 100 - 37% open · ⏱️ 04.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/nbval) (📥 160K / month):
	```
	pip install nbval
	```
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 5 · 🔀 17 · 📦 370 · 📋 59 - 3% open · ⏱️ 18.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 52K / month):
	```
	pip install ipytest
	```
</details>
...
- [GitHub](https://github.com/jupyter/jupyter-sphinx) (👨‍💻 28 · 🔀 60 · 📋 150 - 28% open · ⏱️ 04.03.2024):
...
- [GitHub](https://github.com/QuantEcon/sphinxcontrib-jupyter) (👨‍💻 13 · 🔀 23 · 📦 38 · 📋 180 - 48% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinxcontrib-jupyter) (📥 1.7K / month):
	```
...
<details><summary><b><a href="https://github.com/stas00/ipyexperiments">ipyexperiments</a></b> (🥉12 ·  ⭐ 180) - jupyter/ipython experiment containers for GPU and.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 55 · 📦 620 · 📋 28 - 71% open · ⏱️ 19.05.2020):
...
- [GitHub](https://github.com/plotly/jupyterlab-chart-editor) (👨‍💻 5 · 🔀 24 · 📦 7 · 📋 31 - 38% open · ⏱️ 10.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-chart-editor) (📥 370 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 27 · 📦 1.3K · 📋 25 - 32% open · ⏱️ 20.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 120 / month):
	```
...
- [GitHub](https://github.com/yeebc/jupyterlab-neon-theme) (👨‍💻 4 · 🔀 8 · 📦 4 · 📋 13 - 15% open · ⏱️ 28.08.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@yeebc/jupyterlab_neon_theme) (📥 77 / month):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 16 · 📦 8 · 📋 18 - 16% open · ⏱️ 16.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 78 / month):
	```
...
- [GitHub](https://github.com/Rahlir/theme-gruvbox) (👨‍💻 3 · 🔀 9 · 📦 4 · ⏱️ 12.04.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@rahlir/theme-gruvbox) (📥 40 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 40 · 📋 260 - 6% open · ⏱️ 31.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 67K / month):
	```
	npm install @jupyterlab/debugger
	```
</details>
<details><summary><b><a href="https://github.com/finos/jupyterlab_templates">JupyterLab Templates</a></b> (🥇20 ·  ⭐ 360) - Support for jupyter notebook templates in jupyterlab. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 59K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 190 / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/jupyterlab-sidecar) (👨‍💻 16 · 🔀 39 · 📦 7 · 📋 35 - 62% open · ⏱️ 30.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/sidecar) (📥 7.5K / month):
	```
	pip install sidecar
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 12K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 13 / month):
	```
...
- [GitHub](https://github.com/krassowski/jupyterlab-go-to-definition) (👨‍💻 2 · 🔀 9 · 📦 17 · 📋 23 - 43% open · ⏱️ 28.07.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab_go_to_definition) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 500 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 68 / month):
	```
...
- [GitHub](https://github.com/microsoft/gather) (👨‍💻 13 · 🔀 35 · 📦 3 · 📋 27 - 33% open · ⏱️ 28.11.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 15 / month):
	```
...
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥉13 ·  ⭐ 87) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab-kernelspy">JupyterLab Kernelspy</a></b> (🥉12 ·  ⭐ 76) - A Jupyter Lab extension for inspecting messages.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📥 24 · 📦 7 · 📋 13 - 15% open · ⏱️ 08.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 22 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 11 · 📥 99 · 📦 3 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 82 / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 🔀 1 · 📥 4 · 📦 3 · 📋 3 - 33% open · ⏱️ 10.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 570 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📦 3 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 6 / month):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📦 3 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 15 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 120 · 🔀 330 · 📦 410 · 📋 290 - 15% open · ⏱️ 13.02.2024):
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 18 · 🔀 48 · 📦 110 · 📋 50 - 6% open · ⏱️ 06.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ltiauthenticator) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 7 · 🔀 10 · 📦 110 · ⏱️ 17.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/nullauthenticator) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 26 · 📋 19 - 42% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 440 / month):
	```
...
- [GitHub](https://github.com/thedataincubator/jupyterhub-hashauthenticator) (👨‍💻 3 · 🔀 3 · ⏱️ 04.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-hashauthenticator) (📥 38 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 69 · 🔀 290 · 📦 180 · 📋 270 - 8% open · ⏱️ 01.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/dockerspawner) (📥 73K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 45 · 🔀 120 · 📦 32 · 📋 140 - 41% open · ⏱️ 20.02.2024):

	```
	git clone https://github.com/jupyterhub/batchspawner
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 3.8K / month):
	```
...
- [GitHub](https://github.com/uktrade/fargatespawner) (👨‍💻 3 · 🔀 21 · 📦 4 · 📋 11 - 54% open · ⏱️ 28.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/fargatespawner) (📥 350 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 980 · 🔀 4.3K · 📥 320K · 📦 510K · 📋 7.3K - 21% open · ⏱️ 07.03.2024):

	```
	git clone https://github.com/ipython/ipython
	```
- [PyPi](https://pypi.org/project/ipython) (📥 41M / month):
	```
	pip install ipython
	```
...
<details><summary><b><a href="https://github.com/holoviz/panel">panel</a></b> (🥈30 ·  ⭐ 3.9K) - A high-level app and dashboarding solution for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
