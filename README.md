...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 610 · 🔀 3.7K · 📥 7.4K · 📦 8 · 📋 4.4K - 46% open · ⏱️ 17.05.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 280 · 🔀 1.6K · 📦 1.7K · 📋 2.1K - 8% open · ⏱️ 13.05.2022):

	```
	git clone https://github.com/jupyterhub/jupyterhub
	```
- [PyPi](https://pypi.org/project/jupyterhub) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 150 · 🔀 790 · 📋 290 - 6% open · ⏱️ 18.05.2022):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 42 · 📥 750 · 📦 69 · 📋 110 - 3% open · ⏱️ 04.05.2022):
...
<details><summary><b><a href="https://github.com/microsoft/vscode-jupyter">VSCode Jupyter</a></b> (🥉16 ·  ⭐ 620) - VS Code Jupyter extension. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 190 · 🔀 800 · 📦 4K · 📋 1.8K - 32% open · ⏱️ 10.05.2022):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 600 · 🔀 3.8K · 📦 51K · 📋 6.9K - 9% open · ⏱️ 15.05.2022):
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 78 · 🔀 310 · 📦 1.7K · 📋 480 - 37% open · ⏱️ 17.05.2022):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 65K / month):
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 57 · 🔀 440 · 📦 30 · 📋 570 - 37% open · ⏱️ 09.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 70K / month):
	```
	pip install bqplot
	```
...
- [PyPi](https://pypi.org/project/ipympl) (📥 99K / month):
	...
	pip install ipympl
	```
- [NPM](https://www.npmjs.com/package/jupyter-matplotlib) (📥 41K / month):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 17 · 🔀 48 · 📦 540 · 📋 110 - 38% open · ⏱️ 05.05.2022):
...
<details><summary><b><a href="https://github.com/InsightSoftwareConsortium/itkwidgets">itkwidgets</a></b> (🥈20 ·  ⭐ 430) - Interactive Jupyter widgets to visualize images, point sets, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mwouts/itables) (👨‍💻 3 · 🔀 25 · 📦 110 · 📋 41 - 21% open · ⏱️ 13.04.2022):

	```
	git clone https://github.com/mwouts/itables
	```
- [PyPi](https://pypi.org/project/itables) (📥 6K / month):
	```
	pip install itables
	```
</details>
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 130 · 📋 100 - 54% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/witwidget) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 490 · 📋 9 - 33% open · ⏱️ 19.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 50K / month):
	```
...
- [GitHub](https://github.com/g2nb/igv-jupyter) (👨‍💻 5 · 🔀 15 · 📦 10 · ⏱️ 28.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/igv-jupyter) (📥 370 / month):
	```
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 8 · 📋 6 - 33% open · ⏱️ 14.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 630K / month):
	```
...
<details><summary><b><a href="https://github.com/jpmorganchase/ipyregulartable">ipyregulartable</a></b> (🥉16 ·  ⭐ 62) - High performance, editable, stylable datagrids in jupyter.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 26 · 🔀 29 · 📋 580 - 40% open · ⏱️ 18.05.2022):
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 17 · 🔀 220 · 📋 94 - 35% open · ⏱️ 19.05.2022):
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 3 · 🔀 10 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 210 / month):
	```
	pip install ipyannotate
	```
- [NPM](https://www.npmjs.com/package/ipyannotate) (📥 20 / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 22 · 🔀 69 · 📥 46 · 📋 57 - 52% open · ⏱️ 27.04.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 62 · 🔀 110 · 📦 4 · 📋 150 - 39% open · ⏱️ 29.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 1.8M / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyter-archive">jupyter-archive</a></b> (🥉16 ·  ⭐ 54) - A Jupyter/Jupyterlab extension to make, download and extract.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 15 · 📦 280 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 600 / month):
	```
	pip install nbzip
	```
</details>
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 290 · 📥 410 · 📋 400 - 51% open · ⏱️ 18.05.2022):
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 29 · 🔀 76 · 📥 27 · 📋 140 - 19% open · ⏱️ 03.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 350K / month):
	```
...
- [GitHub](https://github.com/IHaskell/IHaskell) (👨‍💻 110 · 🔀 240 · 📦 4 · 📋 730 - 3% open · ⏱️ 11.05.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/ihaskell_jupyterlab) (📥 40 / month):
	```
...
- [GitHub](https://github.com/almond-sh/almond) (👨‍💻 35 · 🔀 220 · 📥 1.2K · 📋 290 - 34% open · ⏱️ 17.05.2022):
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 27 · 📦 81 · 📋 35 - 48% open · ⏱️ 20.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/spylon-kernel) (📥 8.1K / month):
	```
...
- [GitHub](https://github.com/SpencerPark/IJava) (👨‍💻 4 · 🔀 150 · 📥 81K · 📋 120 - 53% open · ⏱️ 08.12.2019):
...
<details><summary><b><a href="https://github.com/ansible/ansible-jupyter-kernel">Ansible Kernel</a></b> (🥉17 ·  ⭐ 490) - Jupyter Notebook Kernel for running Ansible Tasks and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 72 · 📋 56 - 5% open · ⏱️ 21.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 1.2K / month):
	```
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 11 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 94 / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupytext) (📥 310K · ⏱️ 06.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-jupytext) (📥 9.3K / month):
	```
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 67 · 🔀 650 · 📋 280 - 41% open · ⏱️ 11.05.2022):
...
- [GitHub](https://github.com/nteract/bookstore) (👨‍💻 7 · 🔀 18 · 📦 10 · 📋 73 - 46% open · ⏱️ 09.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/bookstore) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/SamLau95/nbinteract) (👨‍💻 8 · 🔀 20 · 📦 1 · 📋 70 - 41% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbinteract) (📥 1.2K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥇26 ·  ⭐ 93) - A client library for executing notebooks. Formally nbconvert's.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 32 · 🔀 41 · 📥 54 · 📦 54K · 📋 88 - 30% open · ⏱️ 09.05.2022):
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 66 · 🔀 330 · 📋 380 - 24% open · ⏱️ 05.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 97K / month):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 120 · 🔀 220 · 📥 230 · 📋 310 - 44% open · ⏱️ 17.05.2022):
...
- [Conda](https://anaconda.org/conda-forge/beakerx) (📥 510K · ⏱️ 18.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/beakerx) (📥 560 / month):
	```
	npm install beakerx
	```
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 110 · 🔀 850 · 📋 330 - 16% open · ⏱️ 18.05.2022):
...
- [GitHub](https://github.com/krassowski/jupyter-helpers) (👨‍💻 2 · 🔀 3 · 📋 5 - 60% open · ⏱️ 31.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_helpers) (📥 92 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 57 · 📦 230 · 📋 28 - 71% open · ⏱️ 19.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-dash) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 62 · 📦 320 · 📋 65 - 61% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 21 · 📦 300 · 📋 23 - 30% open · ⏱️ 26.08.2021):
...
<details><summary><b><a href="https://github.com/AllanChain/jupyterlab-theme-solarized-dark">jupyterlab-theme-solarized-dark</a></b> (🥈14 ·  ⭐ 62) - JupyterLab 2.x Solarized Dark extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/AllanChain/jupyterlab-theme-solarized-dark) (👨‍💻 2 · 🔀 8 · 📋 2 - 50% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark) (📥 760 / month):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 14 · 📦 4 · 📋 17 - 17% open · ⏱️ 31.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 690 / month):
	```
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 69 · 🔀 460 · 📦 250 · 📋 510 - 13% open · ⏱️ 19.05.2022):
...
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈18 ·  ⭐ 540) - A universal code formatter for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 50 · 📦 4 · 📋 78 - 10% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 7.8K / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 7 · 🔀 29 · 📦 37 · 📋 39 - 48% open · ⏱️ 15.02.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-system-monitor) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 400 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 84 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 4 · 🔀 9 · 📦 3 · 📋 13 - 15% open · ⏱️ 19.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 400 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 5 · 🔀 9 · 📋 31 - 6% open · ⏱️ 30.04.2022):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 8 · 🔀 14 · 📋 13 - 53% open · ⏱️ 17.01.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 520 / month):
	```
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 10 · 🔀 20 · 📋 16 - 50% open · ⏱️ 01.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 240 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 17 · 📋 110 - 27% open · ⏱️ 30.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 84 / month):
	```
	pip install nbcelltests
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_celltests) (📥 73 / month):
	```
	npm install jupyterlab_celltests
	```
</details>
<details><summary><b><a href="https://github.com/jtpio/jupyterlab-python-file">JupyterLab Python Files</a></b> (🥉13 ·  ⭐ 52 · 💤) - JupyterLab extension to create Python files. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 110 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_email) (📥 89 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 9 · 🔀 23 · 📋 53 - 20% open · ⏱️ 29.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 210 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 77 / month):
	```
...
- [GitHub](https://github.com/ReviewNB/jupyterlab-gitplus) (👨‍💻 2 · 🔀 7 · 📋 10 - 20% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 95 / month):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 52 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 1 · ⏱️ 07.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 📥 3 · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 42 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 30 · 🔀 150 · 📦 92 · 📋 140 - 40% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/jupyterhub/ldapauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-ldapauthenticator) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 50 · 📦 37 · 📋 91 - 24% open · ⏱️ 17.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 7 · 🔀 9 · 📦 78 · ⏱️ 17.05.2022):
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 68 · 🔀 240 · 📦 110 · 📋 280 - 16% open · ⏱️ 19.05.2022):

	```
	git clone https://github.com/jupyterhub/kubespawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 9 · 📋 9 - 55% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 81 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 880 · 🔀 4.2K · 📥 320K · 📦 280K · 📋 6.9K - 21% open · ⏱️ 03.05.2022):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 460 · 🔀 170 · 📥 350 · 📋 270 - 33% open · ⏱️ 16.05.2022):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 3.3M / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 28 · 🔀 42 · 📥 10 · 📋 38 - 26% open · ⏱️ 17.05.2022):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 95 · 🔀 250 · 📦 3.3K · 📋 1.8K - 27% open · ⏱️ 19.05.2022):
