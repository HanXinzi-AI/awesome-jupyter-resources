...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 570 · 🔀 3.5K · 📥 3.9K · 📦 130K · 📋 4.3K - 46% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 260 · 🔀 1.6K · 📦 1.6K · 📋 2K - 8% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 210 · 🔀 2.4K · 📋 710 - 10% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 170 · 🔀 520 · 📥 1.3M · 📋 1.7K - 9% open · ⏱️ 04.01.2022):
...
- [GitHub](https://github.com/googledatalab/datalab) (👨‍💻 52 · 🔀 240 · 📋 890 - 25% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/datalab) (📥 1.2M / month):
	```
	pip install datalab
	```
</details>
...
- [GitHub](https://github.com/ml-tooling/ml-workspace) (👨‍💻 10 · 🔀 300 · 📋 75 - 6% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 140 · 🔀 770 · 📋 280 - 4% open · ⏱️ 05.01.2022):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 16 · 🔀 36 · 📥 320 · 📦 44 · 📋 120 - 33% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/jtpio/jupyterlab-classic
	```
- [PyPi](https://pypi.org/project/jupyterlab-classic) (📥 30 / month):
	```
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 240 · 🔀 98 · 📋 6.6K - 9% open · ⏱️ 06.01.2022):
...
- [GitHub](https://github.com/pandas-profiling/pandas-profiling) (👨‍💻 83 · 🔀 1.2K · 📦 6.3K · 📋 530 - 17% open · ⏱️ 01.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 1.9M / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 190 · 🔀 760 · 📦 3K · 📋 1.7K - 31% open · ⏱️ 23.12.2021):
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 25 · 🔀 170 · 📦 2.3K · 📋 220 - 41% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/matplotlib/ipympl
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 58K / month):
	```
	pip install ipympl
	```
...
- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 28 · 🔀 820 · 📦 93 · 📋 150 - 50% open · ⏱️ 06.05.2021):

	```
	git clone https://github.com/pair-code/facets
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 94K / month):
	```
...
- [GitHub](https://github.com/maartenbreddels/ipyvolume) (👨‍💻 39 · 🔀 210 · 📦 650 · 📋 290 - 55% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/maartenbreddels/ipyvolume
	```
- [PyPi](https://pypi.org/project/ipyvolume) (📥 22K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 340K · ⏱️ 20.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 19 · 🔀 220 · 📦 280 · 📋 440 - 8% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/man-group/dtale
	```
- [PyPi](https://pypi.org/project/dtale) (📥 45K / month):
	```
	pip install dtale
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 14 · 🔀 40 · 📦 340 · 📋 98 - 35% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/martinRenou/ipycanvas
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 3 · 🔀 170 · 📥 65 · 📦 1.1K · 📋 49 - 69% open · ⏱️ 22.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 37K / month):
	```
...
- [GitHub](https://github.com/mapbox/mapboxgl-jupyter) (👨‍💻 21 · 🔀 120 · 📦 120 · 📋 99 - 32% open · ⏱️ 19.04.2021):
...
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 330K · ⏱️ 04.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 700 / month):
	```
	npm install qgrid
	```
</details>
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 29 · 🔀 160 · 📦 19 · 📋 210 - 31% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 30K / month):
	```
...
- [GitHub](https://github.com/maartenbreddels/ipywebrtc) (👨‍💻 9 · 🔀 30 · 📦 400 · 📋 48 - 58% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipywebrtc) (📥 24K / month):
	```
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 120 · 📋 95 - 50% open · ⏱️ 05.01.2022):
...
- [PyPi](https://pypi.org/project/witwidget) (📥 6.1K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/wit-widget) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/mariobuikhuizen/ipyvuetify) (👨‍💻 10 · 🔀 37 · 📦 4 · 📋 150 - 22% open · ⏱️ 16.12.2021):

	```
	git clone https://github.com/mariobuikhuizen/ipyvuetify
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 34K / month):
	```
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 10 · 🔀 57 · 📦 3 · 📋 110 - 50% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipysheet) (📥 16K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipysheet) (📥 41K · ⏱️ 11.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysheet) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 10 · 🔀 54 · 📋 92 - 11% open · ⏱️ 02.01.2022):
...
- [PyPi](https://pypi.org/project/itkwidgets) (📥 4.6K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/itkwidgets) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 25 · 📦 15 · 📋 80 - 12% open · ⏱️ 24.12.2021):

	```
	git clone https://github.com/timkpaine/tributary
	```
- [PyPi](https://pypi.org/project/tributary) (📥 79 / month):
	```
...
<details><summary><b><a href="https://github.com/vidartf/ipydatawidgets">ipydatawidgets</a></b> (🥉17 ·  ⭐ 27 · 💤) - A set of widgets to help facilitate reuse of large.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 420 · 📋 9 - 33% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 39K / month):
	```
...
<details><summary><b><a href="https://github.com/jpmorganchase/ipyregulartable">ipyregulartable</a></b> (🥉16 ·  ⭐ 53) - High performance, editable, stylable datagrids in jupyter.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jpmorganchase/ipyregulartable) (👨‍💻 4 · 🔀 9 · 📦 8 · 📋 24 - 37% open · ⏱️ 11.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 44 / month):
	```
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 25 · 🔀 26 · 📋 480 - 43% open · ⏱️ 06.01.2022):
...
- [GitHub](https://github.com/igvteam/igv-jupyter) (👨‍💻 4 · 🔀 14 · 📦 6 · ⏱️ 22.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/igv-jupyter) (📥 100 / month):
	```
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 11 · 🔀 160 · 📋 63 - 53% open · ⏱️ 29.12.2021):
...
- [GitHub](https://github.com/CermakM/jupyter-datatables) (👨‍💻 4 · 🔀 14 · 📋 28 - 46% open · ⏱️ 11.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-datatables) (📥 280 / month):
	```
...
- [GitHub](https://github.com/Yomguithereal/ipysigma) (👨‍💻 3 · 🔀 4 · 📋 5 - 60% open · ⏱️ 30.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 11 / month):
	```
...
- [GitHub](https://github.com/DGothrek/ipyaggrid) (👨‍💻 2 · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 2K / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 3 · 🔀 10 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 25 / month):
	```
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 3 · 🔀 2 · 📦 1 · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 56 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 84 · 🔀 260 · 📋 780 - 25% open · ⏱️ 03.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 2K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 20 · 🔀 64 · 📥 4 · 📋 55 - 50% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/jupyter-server/jupyter-resource-usage
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 12K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 23 · 🔀 51 · 📦 410 · 📋 120 - 39% open · ⏱️ 28.12.2021):
...
- [GitHub](https://github.com/mozilla/jupyter-spark) (👨‍💻 12 · 🔀 30 · 📦 16 · 📋 27 - 48% open · ⏱️ 01.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-spark) (📥 2.3K / month):
	```
	pip install jupyter-spark
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-rsession-proxy">Rsession Proxy</a></b> (🥉16 ·  ⭐ 83) - Jupyter extensions for running an RStudio rsession proxy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 19 · 🔀 59 · 📦 34 · 📋 66 - 36% open · ⏱️ 22.12.2021):
...
- [GitHub](https://github.com/googlecolab/jupyter_http_over_ws) (👨‍💻 3 · 🔀 34 · 📋 26 - 73% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 27K / month):
	```
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 15 · 📦 250 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 580 / month):
	```
	pip install nbzip
	```
</details>
...
- [GitHub](https://github.com/paypal/PPExtensions) (👨‍💻 9 · 🔀 26 · 📦 1 · 📋 38 - 42% open · ⏱️ 07.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/ppextensions) (📥 30 / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 44 · 🔀 230 · 📦 2.6K · 📋 140 - 72% open · ⏱️ 29.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipython-sql) (📥 67K / month):
	```
...
<details><summary><b><a href="https://github.com/rasbt/watermark">watermark</a></b> (🥈24 ·  ⭐ 580) - An IPython magic extension for printing date and time stamps, version.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 35K / month):
	```
	pip install pick
	```
</details>
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 280 · 📥 130 · 📦 150K · 📋 370 - 50% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 14 · 🔀 140 · 📦 55 · 📋 220 - 20% open · ⏱️ 01.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ijavascript) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/jupyter/enterprise_gateway) (👨‍💻 86 · 🔀 150 · 📥 12K · 📋 500 - 18% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_enterprise_gateway) (📥 600 / month):
	```
...
- [GitHub](https://github.com/jupyter/kernel_gateway) (👨‍💻 44 · 🔀 110 · 📥 100 · 📋 180 - 8% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 23 · 📦 67 · 📋 34 - 47% open · ⏱️ 20.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/spylon-kernel) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/gibiansky/IHaskell) (👨‍💻 100 · 🔀 240 · 📋 720 - 3% open · ⏱️ 25.12.2021):
...
<details><summary><b><a href="https://github.com/fsprojects/IfSharp">F# Kernel</a></b> (🥉16 ·  ⭐ 440 · 💀) - F# for Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 71 · 📋 55 - 5% open · ⏱️ 21.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 570 / month):
	```
...
- [GitHub](https://github.com/Cadair/jupyter_environment_kernels) (👨‍💻 6 · 🔀 15 · 📋 29 - 24% open · ⏱️ 12.02.2018):

	```
	git clone https://github.com/Cadair/jupyter_environment_kernels
	```
- [PyPi](https://pypi.org/project/environment_kernels) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/Calysto/matlab_kernel) (👨‍💻 17 · 🔀 72 · 📋 130 - 19% open · ⏱️ 09.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 720 / month):
	```
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 10 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 47 / month):
	```
...
- [GitHub](https://github.com/tdaff/remote_ikernel) (👨‍💻 7 · 🔀 9 · 📋 26 - 30% open · ⏱️ 08.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/remote_ikernel) (📥 240 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/nbconvert">nbconvert</a></b> (🥇31 ·  ⭐ 1.2K) - Jupyter Notebook Conversion. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 340 · 📦 400 · 📋 2.1K - 1% open · ⏱️ 31.12.2021):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 56 · 🔀 370 · 📥 110 · 📦 5.6K · 📋 550 - 41% open · ⏱️ 23.12.2021):
...
- [Conda](https://anaconda.org/conda-forge/voila) (📥 160K · ⏱️ 22.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 2.9K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 420K · ⏱️ 26.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 57K / month):
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 26 · 🔀 32 · 📥 990 · 📦 16 · 📋 540 - 9% open · ⏱️ 23.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/stencila) (📥 89 / month):
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 98 · 🔀 400 · 📋 970 - 38% open · ⏱️ 06.01.2022):
...
- [GitHub](https://github.com/nteract/bookstore) (👨‍💻 7 · 🔀 18 · 📦 7 · 📋 73 - 46% open · ⏱️ 09.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/bookstore) (📥 88K / month):
	```
...
<details><summary><b><a href="https://github.com/aaren/notedown">notedown</a></b> (🥉17 ·  ⭐ 780 · 💀) - Markdown = IPython Notebook. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 23 · 📦 86 · 📋 48 - 47% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/ideonate/cdsdashboards) (👨‍💻 11 · 🔀 25 · 📋 77 - 35% open · ⏱️ 21.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/cdsdashboards) (📥 360 / month):
	```
...
<details><summary><b><a href="https://github.com/SamLau95/nbinteract">nbinteract</a></b> (🥉13 ·  ⭐ 210 · 💤) - Create interactive webpages from Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b> (🥉13 ·  ⭐ 99) - Use Jupyter Notebook in mkdocs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥇28 ·  ⭐ 83) - A client library for executing notebooks. Formally nbconvert's.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 28 · 🔀 39 · 📥 10 · 📦 39K · 📋 74 - 27% open · ⏱️ 05.01.2022):
...
- [Conda](https://anaconda.org/conda-forge/beakerx) (📥 480K · ⏱️ 18.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/beakerx) (📥 900 / month):
	```
	npm install beakerx
	```
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 29 · 🔀 39 · 📦 1.2K · 📋 95 - 35% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/computationalmodelling/nbval
	```
- [PyPi](https://pypi.org/project/nbval) (📥 72K / month):
	```
	pip install nbval
	```
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 100 · 🔀 820 · 📦 1.8K · 📋 310 - 15% open · ⏱️ 04.01.2022):
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 100 · 🔀 270 · 📦 140 · 📋 440 - 31% open · ⏱️ 03.01.2022):
...
- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 17 · 🔀 23 · 📋 240 - 1% open · ⏱️ 03.01.2022):

	```
	git clone https://github.com/nbQA-dev/nbQA
	```
- [PyPi](https://pypi.org/project/nbqa) (📥 16K / month):
	```
	pip install nbqa
	```
</details>
...
- [GitHub](https://github.com/QuantEcon/sphinxcontrib-jupyter) (👨‍💻 13 · 🔀 23 · 📦 24 · 📋 180 - 48% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinxcontrib-jupyter) (📥 410 / month):
	```
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 19 · 📦 35 · 📋 11 - 18% open · ⏱️ 08.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 3.6K / month):
	```
	pip install treon
	```
</details>
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 18 · 📦 130 · 📋 43 - 4% open · ⏱️ 28.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 9.1K / month):
	```
	pip install ipytest
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyter-naas/naas">naas</a></b> (🥉13 ·  ⭐ 150) - Schedule notebooks, run them like APIs, expose securely your assets:.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 13 · 🔀 11 · 📦 3 · 📋 120 - 66% open · ⏱️ 23.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/naas) (📥 4.2K / month):
	```
	pip install naas
	```
</details>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-latex) (👨‍💻 21 · 🔀 56 · 📦 2 · 📋 82 - 34% open · ⏱️ 28.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 870 / month):
	```
...
<details><summary><b><a href="https://github.com/QuantStack/jupyterlab-drawio">JupyterLab Drawio</a></b> (🥈17 ·  ⭐ 510 · 💤) - A standalone embedding of the FOSS drawio / mxgraph.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 57 · 📦 170 · 📋 64 - 60% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/QuantStack/jupyterlab-drawio
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-drawio) (📥 3.6K / month):
	```
	npm install jupyterlab-drawio
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab/jupyter-renderers">JupyterLab Renderers</a></b> (🥉16 ·  ⭐ 420) - Renderers and renderer extensions for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 23 · 🔀 59 · 📦 1 · 📋 100 - 31% open · ⏱️ 31.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 5K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-chart-editor) (👨‍💻 5 · 🔀 20 · 📦 3 · 📋 31 - 38% open · ⏱️ 10.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-chart-editor) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 31 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 52 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 18 · 📦 150 · 📋 21 - 23% open · ⏱️ 26.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-solarized-dark) (📥 2.8K / month):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 14 · 📦 4 · 📋 16 - 12% open · ⏱️ 31.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 640 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-theme-toggle) (👨‍💻 2 · 🔀 2 · 📦 2 · 📋 3 - 66% open · ⏱️ 16.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-toggle) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 38 · 🔀 83 · 📦 100 · 📋 380 - 32% open · ⏱️ 01.01.2022):
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 65 · 🔀 420 · 📦 220 · 📋 480 - 12% open · ⏱️ 05.01.2022):
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 38 · 🔀 200 · 📦 28 · 📋 1.3K - 17% open · ⏱️ 30.12.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 14 · 🔀 100 · 📦 160 · 📋 120 - 55% open · ⏱️ 10.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/toc) (📥 93K / month):
	```
	npm install @jupyterlab/toc
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab/debugger">JupyterLab Debugger</a></b> (🥈20 ·  ⭐ 530 · 💤) - A visual debugger for Jupyter notebooks, consoles,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 36 · 📋 260 - 6% open · ⏱️ 31.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 74K / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 6 · 🔀 26 · 📦 27 · 📋 35 - 45% open · ⏱️ 02.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-system-monitor) (📥 8.3K / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 49 · 📦 4 · 📋 78 - 10% open · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/dask/dask-labextension) (👨‍💻 18 · 🔀 44 · 📋 120 - 27% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/dask/dask-labextension
	```
- [PyPi](https://pypi.org/project/dask-labextension) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/jwkvam/jupyterlab-vim) (👨‍💻 8 · 🔀 72 · 📦 3 · 📋 96 - 56% open · ⏱️ 16.07.2019):
...
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈16 ·  ⭐ 490 · 💤) - A universal code formatter for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter):
	...
	```
- [NPM](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 4.9K / month):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 15 · 🔀 52 · 📋 52 - 46% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 8.4K / month):
	```
...
- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 2 · 🔀 19 · 📦 14 · 📋 200 - 5% open · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pylantern) (📥 79 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 15 · 📦 3 · 📋 64 - 9% open · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 450 / month):
	```
	pip install jupyterlab_iframe
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_iframe) (📥 830 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter-widgets/jupyterlab-sidecar">JupyterLab SideCar</a></b> (🥉15 ·  ⭐ 190) - A sidecar output widget for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 5 · 🔀 4 · 📥 21 · 📋 26 - 34% open · ⏱️ 14.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 1.2K / month):
	```
	pip install ipylab
	```
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 16 · 🔀 36 · 📋 79 - 11% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 4.4K / month):
	```
	pip install jupyter-bokeh
	```
- [NPM](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 18K / month):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 10 · 🔀 24 · 📋 27 - 3% open · ⏱️ 01.10.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 8 · 🔀 15 · 📋 13 - 53% open · ⏱️ 17.01.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 280 / month):
	```
...
- [GitHub](https://github.com/microsoft/gather) (👨‍💻 12 · 🔀 27 · 📋 26 - 38% open · ⏱️ 14.02.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 65 / month):
	```
...
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉13 ·  ⭐ 68) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 200 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 92 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 8 · 📥 76 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-hdf5) (👨‍💻 6 · 🔀 17 · 📋 42 - 21% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 350 / month):
	```
	pip install jupyterlab_hdf
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 270 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 4 · 🔀 8 · 📦 3 · 📋 13 - 15% open · ⏱️ 01.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/nbcelltests) (📥 38 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_celltests) (📥 95 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 4 · 🔀 6 · 📋 29 - 17% open · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 110 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 36 - 16% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 95 / month):
	```
	pip install jupyterlab_email
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_email) (📥 100 / month):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 51 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 1 · ⏱️ 07.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 8.6K / month):
	```
...
<details><summary><b><a href="https://github.com/ReviewNB/jupyterlab-gitplus">jupyterlab-gitplus</a></b> (🥉8 ·  ⭐ 89) - JupyterLab extension to create GitHub commits & pull.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/ReviewNB/jupyterlab-gitplus) (👨‍💻 2 · 🔀 8 · 📋 10 - 20% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 54 / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 📥 2 · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 12 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 100 · 🔀 290 · 📦 240 · 📋 210 - 12% open · ⏱️ 27.12.2021):
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 30 · 🔀 150 · 📦 85 · 📋 130 - 41% open · ⏱️ 27.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ldapauthenticator) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 26 · 📋 16 - 43% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/thedataincubator/jupyterhub-hashauthenticator) (👨‍💻 3 · 🔀 3 · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-hashauthenticator) (📥 45 / month):
	```
...
- [GitHub](https://github.com/ucphhpc/jhub-authenticators) (👨‍💻 5 · 🔀 1 · ⏱️ 25.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jhub-authenticators) (📥 41 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kerberosauthenticator) (👨‍💻 2 · 🔀 4 · 📋 5 - 60% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kerberosauthenticator) (📥 12 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 66 · 🔀 230 · 📦 100 · 📋 270 - 19% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 98K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 62 · 🔀 270 · 📦 110 · 📋 250 - 5% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/dockerspawner) (📥 5.3K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 38 · 🔀 91 · 📦 11 · 📋 110 - 37% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 430 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 14 · 🔀 36 · 📦 36 · 📋 37 - 45% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 710 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 850 · 🔀 4.1K · 📥 320K · 📦 240K · 📋 6.8K - 21% open · ⏱️ 05.01.2022):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 450 · 🔀 140 · 📥 190 · 📋 220 - 30% open · ⏱️ 04.01.2022):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 990K / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 22 · 🔀 37 · 📋 31 - 29% open · ⏱️ 29.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 200K / month):
	```
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 82 · 🔀 210 · 📦 2.5K · 📋 1.6K - 29% open · ⏱️ 06.01.2022):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 280K / month):
	```
	pip install panel
	```
...
- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 110 · 🔀 160 · 📦 91K · 📋 290 - 33% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/abhishekkrthakur/colabcode) (👨‍💻 8 · 🔀 220 · 📦 50 · 📋 62 - 51% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 11K / month):
	```
