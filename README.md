...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 620 · 🔀 3.9K · 📥 10K · 📦 13 · 📋 4.5K - 44% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 530 · 📥 1.4M · 📋 1.7K - 9% open · ⏱️ 26.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 230 · 🔀 2.7K · 📋 800 - 3% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 45 · 📥 830 · 📦 95 · 📋 110 - 2% open · ⏱️ 04.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-classic) (📥 60 / month):
	```
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 260 · 🔀 180 · 📋 8.3K - 4% open · ⏱️ 29.12.2022):
...
- [Conda](https://anaconda.org/conda-forge/ipywidgets) (📥 7.4M · ⏱️ 22.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-manager) (📥 61K / month):
	```
...
- [GitHub](https://github.com/widgetti/ipyvolume) (👨‍💻 41 · 🔀 220 · 📦 930 · 📋 300 - 57% open · ⏱️ 26.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipyvolume) (📥 61K / month):
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 30 · 🔀 200 · 📦 4.8K · 📋 270 - 45% open · ⏱️ 19.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 140K / month):
	```
	pip install ipympl
	```
...
- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 28 · 🔀 860 · 📦 150 · 📋 150 - 50% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 430K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/pythreejs) (📥 450K · ⏱️ 06.09.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-threejs) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/quantopian/qgrid) (👨‍💻 30 · 🔀 400 · 📋 280 - 54% open · ⏱️ 07.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/qgrid) (📥 64K / month):
	```
	pip install qgrid
	```
...
- [GitHub](https://github.com/mwouts/itables) (👨‍💻 5 · 🔀 31 · 📦 190 · 📋 71 - 9% open · ⏱️ 23.12.2022):

	```
	git clone https://github.com/mwouts/itables
	```
- [PyPi](https://pypi.org/project/itables) (📥 16K / month):
	```
	pip install itables
	```
</details>
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 5 · 🔀 64 · 📥 67 · 📋 220 - 42% open · ⏱️ 24.11.2022):

	```
	git clone https://github.com/InsightSoftwareConsortium/itkwidgets
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/nicolaskruchten/jupyter_pivottablejs) (👨‍💻 3 · 🔀 63 · 📦 290 · 📋 60 - 31% open · ⏱️ 04.12.2018):
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 13 · 🔀 64 · 📦 3 · 📋 120 - 49% open · ⏱️ 28.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipysheet) (📥 34K / month):
	```
...
- [GitHub](https://github.com/QuantStack/ipytree) (👨‍💻 9 · 🔀 26 · 📋 36 - 52% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 84K / month):
	```
	pip install ipytree
	```
...
- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 3 · 🔀 6 · 📦 15 · 📋 20 - 15% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipydagred3) (📥 180 / month):
	```
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 8 · 📋 7 - 42% open · ⏱️ 14.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 700K / month):
	```
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 31 · 🔀 42 · 📋 790 - 33% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/spacetelescope/jdaviz
	```
- [PyPi](https://pypi.org/project/jdaviz) (📥 870 / month):
	```
	pip install jdaviz
	```
</details>
<details><summary><b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉16 ·  ⭐ 79 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/medialab/ipysigma">ipysigma</a></b> (🥉16 ·  ⭐ 60) - A custom Jupyter widget library to display graphs using sigma.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/medialab/ipysigma) (👨‍💻 5 · 🔀 9 · 📋 180 - 21% open · ⏱️ 16.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 430 / month):
	```
	pip install ipysigma
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/ipymaterialui) (📥 82 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-materialui) (📥 59 / month):
	```
...
- [GitHub](https://github.com/CermakM/jupyter-datatables) (👨‍💻 4 · 🔀 16 · 📋 28 - 46% open · ⏱️ 11.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-datatables) (📥 430 / month):
	```
...
- [GitHub](https://github.com/leifwalsh/perfume) (👨‍💻 3 · 🔀 4 · 📋 6 - 33% open · ⏱️ 31.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/perfume-bench) (📥 38 / month):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · ⏱️ 05.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/tributary) (📥 86 / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 29 · 🔀 81 · 📥 110 · 📋 62 - 50% open · ⏱️ 22.12.2022):
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 98 · 🔀 290 · 📥 90 · 📋 840 - 26% open · ⏱️ 30.11.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 64 · 🔀 120 · 📦 4 · 📋 160 - 36% open · ⏱️ 15.12.2022):
...
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-rsession-proxy">Rsession Proxy</a></b> (🥈19 ·  ⭐ 99) - Jupyter extensions for running an RStudio rsession proxy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 21 · 🔀 71 · 📦 43 · 📋 75 - 37% open · ⏱️ 24.09.2022):

	```
	git clone https://github.com/jupyterhub/jupyter-rsession-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/krishnan-r/sparkmonitor) (👨‍💻 3 · 🔀 49 · 📥 2.4K · 📋 22 - 68% open · ⏱️ 16.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/sparkmonitor) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 15 · 📦 320 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 3.8K / month):
	```
	pip install nbzip
	```
</details>
...
- [GitHub](https://github.com/mozilla/jupyter-spark) (👨‍💻 12 · 🔀 29 · 📦 17 · 📋 27 - 48% open · ⏱️ 01.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-spark) (📥 420 / month):
	```
...
- [GitHub](https://github.com/Anaconda-Platform/nb_conda) (👨‍💻 14 · 🔀 29 · 📋 63 - 55% open · ⏱️ 11.09.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nb_conda) (📥 450K · ⏱️ 05.06.2022):
	```
...
- [GitHub](https://github.com/drillan/jupyter-black) (👨‍💻 2 · 🔀 21 · 📋 22 - 40% open · ⏱️ 01.02.2020):
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 58 · 🔀 390 · 📦 270 · 📋 420 - 31% open · ⏱️ 31.10.2022):
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 4 · 🔀 39 · 📋 16 - 6% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 69 / month):
	```
	pip install py_d3
	```
</details>
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 59K / month):
	```
	pip install pick
	```
</details>
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 160 · 🔀 320 · 📥 960 · 📦 210K · 📋 440 - 50% open · ⏱️ 26.12.2022):
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 32 · 🔀 78 · 📥 63 · 📦 660 · 📋 140 - 19% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/gopherdata/gophernotes) (👨‍💻 29 · 🔀 220 · 📥 40 · 📦 8 · 📋 180 - 29% open · ⏱️ 08.07.2022):
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 16 · 🔀 150 · 📦 66 · 📋 230 - 22% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/Anaconda-Platform/nb_conda_kernels) (👨‍💻 14 · 🔀 57 · 📋 140 - 27% open · ⏱️ 30.11.2020):
...
- [GitHub](https://github.com/takluyver/bash_kernel) (👨‍💻 16 · 🔀 110 · 📋 96 - 34% open · ⏱️ 18.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/bash_kernel) (📥 9.6K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 44 · 🔀 120 · 📥 100 · 📋 180 - 7% open · ⏱️ 15.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 35K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 110 · 🔀 190 · 📥 24K · 📋 540 - 11% open · ⏱️ 24.12.2022):
...
<details><summary><b><a href="https://github.com/IHaskell/IHaskell">IHaskell</a></b> (🥉16 ·  ⭐ 2.4K) - A Haskell kernel for IPython. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Cadair/jupyter_environment_kernels) (👨‍💻 8 · 🔀 17 · 📋 29 - 20% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/environment_kernels) (📥 5.2K / month):
	```
...
<details><summary><b><a href="https://github.com/lfortran/lfortran">LFortran</a></b> (🥉14 ·  ⭐ 490) - Official mirror of https://gitlab.com/lfortran/lfortran. Please.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 50 · 🔀 52 · 📋 660 - 81% open · ⏱️ 29.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/lfortran) (📥 78 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 250 · 🔀 490 · 📥 170 · 📦 180K · 📋 1.1K - 43% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 74 · 🔀 360 · 📦 3.8K · 📋 560 - 15% open · ⏱️ 11.12.2022):

	```
	git clone https://github.com/mwouts/jupytext
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 600K / month):
	```
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 63 · 🔀 440 · 📥 460 · 📦 7.9K · 📋 640 - 40% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/voila) (📥 98K / month):
	```
	pip install voila
	```
- [Conda](https://anaconda.org/conda-forge/voila) (📥 240K · ⏱️ 27.10.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 810 / month):
	```
...
- [GitHub](https://github.com/damianavila/RISE) (👨‍💻 43 · 🔀 390 · 📦 2.1K · 📋 430 - 33% open · ⏱️ 03.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/RISE) (📥 6.6K / month):
	```
	pip install RISE
	```
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 70 · 🔀 660 · 📋 290 - 42% open · ⏱️ 29.12.2022):
...
- [GitHub](https://github.com/aaren/notedown) (👨‍💻 7 · 🔀 92 · 📦 200 · 📋 68 - 57% open · ⏱️ 16.11.2017):
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 35 · 🔀 37 · 📥 3.2K · 📦 18 · 📋 560 - 11% open · ⏱️ 01.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/stencila) (📥 16 / month):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 63 · 📦 3 · 📋 91 - 57% open · ⏱️ 28.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 97 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 89 · 🔀 340 · 📦 6 · 📋 640 - 28% open · ⏱️ 29.12.2022):
...
- [GitHub](https://github.com/ideonate/cdsdashboards) (👨‍💻 14 · 🔀 37 · 📋 91 - 35% open · ⏱️ 12.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cdsdashboards) (📥 460 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 70 · 🔀 130 · 📥 21 · 📦 190K · 📋 130 - 40% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 33 · 🔀 44 · 📥 170 · 📦 83K · 📋 98 - 33% open · ⏱️ 23.12.2022):
...
- [PyPi](https://pypi.org/project/nbclient) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nbclient) (📥 6.9M · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 30 · 🔀 400 · 📋 760 - 11% open · ⏱️ 17.11.2022):
...
- [GitHub](https://github.com/twosigma/beakerx) (👨‍💻 43 · 🔀 380 · 📥 31 · 📋 4.5K - 7% open · ⏱️ 21.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/beakerx) (📥 4.3K / month):
	```
	pip install beakerx
	```
- [Conda](https://anaconda.org/conda-forge/beakerx) (📥 560K · ⏱️ 03.11.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/beakerx) (📥 360 / month):
	```
	npm install beakerx
	```
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 110 · 🔀 300 · 📦 170 · 📋 490 - 31% open · ⏱️ 20.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 120 · 🔀 240 · 📥 650 · 📋 340 - 44% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 110 · 🔀 910 · 📋 340 - 15% open · ⏱️ 22.11.2022):

	```
	git clone https://github.com/ipython/ipyparallel
	```
- [PyPi](https://pypi.org/project/ipyparallel) (📥 88K / month):
	```
	pip install ipyparallel
	```
- [Conda](https://anaconda.org/conda-forge/ipyparallel) (📥 750K · ⏱️ 21.06.2022):
	```
...
- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 23 · 🔀 36 · 📋 260 - 0% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/nbQA-dev/nbQA
	```
- [PyPi](https://pypi.org/project/nbqa) (📥 40K / month):
	```
	pip install nbqa
	```
</details>
<details><summary><b><a href="https://github.com/QuantEcon/sphinxcontrib-jupyter">sphinxcontrib.jupyter</a></b> (🥈18 ·  ⭐ 72 · 💀) - A Sphinx Extension for Generating Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 5 · 🔀 21 · 📦 61 · 📋 13 - 23% open · ⏱️ 04.08.2022):

	```
	git clone https://github.com/ReviewNB/treon
	```
- [PyPi](https://pypi.org/project/treon) (📥 2.3K / month):
	```
	pip install treon
	```
</details>
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 19 · 📋 52 - 1% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 27K / month):
	```
	pip install ipytest
	```
</details>
...
- [GitHub](https://github.com/takluyver/nbopen) (👨‍💻 11 · 🔀 54 · 📋 63 - 58% open · ⏱️ 15.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbopen) (📥 570 / month):
	```
	pip install nbopen
	```
</details>
...
- [GitHub](https://github.com/tweag/jupyterWith) (👨‍💻 31 · 🔀 87 · 📋 150 - 13% open · ⏱️ 26.12.2022):
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 65 · 📦 1K · 📋 66 - 62% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 58 · 📦 310 · 📋 28 - 71% open · ⏱️ 19.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-dash) (📥 980 / month):
	```
...
- [GitHub](https://github.com/quigleyj97/jupyterlab-spreadsheet) (👨‍💻 4 · 🔀 14 · 📦 3 · 📋 23 - 21% open · ⏱️ 18.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-spreadsheet) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 33 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 76 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 24 · 📦 970 · 📋 23 - 30% open · ⏱️ 20.07.2022):

	```
	git clone https://github.com/telamonian/theme-darcula
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 740 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 38 · 📋 260 - 6% open · ⏱️ 31.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 85K / month):
	```
...
- [GitHub](https://github.com/lckr/jupyterlab-variableInspector) (👨‍💻 19 · 🔀 84 · 📦 3 · 📋 160 - 24% open · ⏱️ 16.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 7 · 🔀 29 · 📦 74 · 📋 43 - 51% open · ⏱️ 15.02.2022):
...
- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 37 · 🔀 49 · 📋 160 - 16% open · ⏱️ 11.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 100K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 36K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 750 / month):
	```
...
- [GitHub](https://github.com/krassowski/jupyterlab-go-to-definition) (👨‍💻 2 · 🔀 8 · 📦 13 · 📋 23 - 43% open · ⏱️ 28.07.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab_go_to_definition) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 3 · 🔀 20 · 📦 17 · 📋 200 - 5% open · ⏱️ 22.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylantern) (📥 94 / month):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 12 · 🔀 35 · 📋 41 - 9% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/deshaw/jupyterlab-execute-time
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-execute-time) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 42K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 11K / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 15 · 📦 3 · 📋 66 - 6% open · ⏱️ 22.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 680 / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-sos) (📥 22K · ⏱️ 07.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-sos) (📥 49 / month):
	```
...
- [GitHub](https://github.com/pbugnion/jupyterlab-sql) (👨‍💻 2 · 🔀 46 · 📋 75 - 50% open · ⏱️ 04.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_sql) (📥 440 / month):
	```
...
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉14 ·  ⭐ 86 · 💤) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 10 · 🔀 20 · 📋 16 - 50% open · ⏱️ 01.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 5.8K / month):
	```
	pip install jupyterlab-sparkmonitor
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 31 / month):
	```
...
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥉14 ·  ⭐ 22 · 🐣) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/krassowski/jupyterlab-lsp) (👨‍💻 45 · ⏱️ 28.09.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 8 · 📋 31 - 29% open · ⏱️ 22.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 210 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@reviewnb/jupyterlab_gitplus) (📥 41 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (👨‍💻 2 · 🔀 2 · 📋 36 - 11% open · ⏱️ 22.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 56 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 7 / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 📥 3 · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 59 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 110 · 🔀 320 · 📦 320 · 📋 230 - 14% open · ⏱️ 20.12.2022):
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 31 · 🔀 150 · 📦 110 · 📋 140 - 40% open · ⏱️ 27.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ldapauthenticator) (📥 6.4K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/nativeauthenticator">Native Authenticator</a></b> (🥈19 ·  ⭐ 58) - JupyterHub-native user authenticator. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 7 · 🔀 20 · 📥 13 · 📋 29 - 51% open · ⏱️ 21.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 270 / month):
	```
	pip install jupyterhub-samlauthenticator
	```
</details>
<details><summary><b><a href="https://github.com/cwaldbieser/jhub_remote_user_authenticator">Remote User Auth</a></b> (🥉10 ·  ⭐ 37 · 💀) - REMOTE_USER authenticator for Jupyterhub. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 26 · 📋 19 - 42% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 140 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 78 · 🔀 260 · 📋 300 - 18% open · ⏱️ 20.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 40K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 18 · 🔀 42 · 📦 21 · 📋 60 - 46% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 14 · 🔀 38 · 📦 46 · 📋 37 - 45% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 770 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/wrapspawner) (👨‍💻 16 · 🔀 50 · 📦 8 · 📋 31 - 54% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 10 · 📋 10 - 60% open · ⏱️ 16.07.2019):

	```
	git clone https://github.com/jupyterhub/yarnspawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 73 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 930 · 🔀 4.2K · 📥 320K · 📦 340K · 📋 7K - 21% open · ⏱️ 26.12.2022):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 490 · 🔀 200 · 📥 910 · 📋 350 - 36% open · ⏱️ 29.12.2022):
...
- [PyPi](https://pypi.org/project/jupyter_server) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_server) (📥 3.2M · ⏱️ 29.12.2022):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 30 · 🔀 46 · 📥 39 · 📋 39 - 23% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 110 · 🔀 310 · 📦 4.9K · 📋 2.1K - 31% open · ⏱️ 26.12.2022):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 310K / month):
	```
	pip install panel
	```
