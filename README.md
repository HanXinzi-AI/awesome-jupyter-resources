...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 650 · 🔀 4.5K · 📥 17K · 📦 270K · 📋 4.8K - 39% open · ⏱️ 14.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/notebook) (📥 25M / month):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 240 · 🔀 2.8K · 📦 21 · 📋 880 - 0% open · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 360 · 🔀 1.9K · 📦 2.8K · 📋 2.4K - 6% open · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 540 · 📥 1.5M · 📦 3 · 📋 1.7K - 9% open · ⏱️ 30.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 910 / month):
	```
...
- [GitHub](https://github.com/googledatalab/datalab) (👨‍💻 53 · 🔀 250 · 📋 890 - 25% open · ⏱️ 02.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/datalab) (📥 84K / month):
	```
	pip install datalab
	```
</details>
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 160 · 🔀 880 · 📋 350 - 9% open · ⏱️ 23.03.2024):
...
<details><summary><b><a href="https://github.com/iot-salzburg/gpu-jupyter">gpu-jupyter</a></b> (🥉16 ·  ⭐ 650) - Leverage the flexibility of Jupyterlab through the power of your.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/ipympl) (📥 290K / month):
	...
	pip install ipympl
	```
- [NPM](https://www.npmjs.com/package/jupyter-matplotlib) (📥 8.6K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipywidgets) (📥 13M · ⏱️ 08.02.2024):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-manager) (📥 77K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 400K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 360 / month):
	```
	npm install qgrid
	```
</details>
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥈23 ·  ⭐ 620) - Interactive Tables in Jupyter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/evidentlyai/evidently">evidently</a></b> (🥈22 ·  ⭐ 4.6K) - Interactive reports to analyze machine learning models during.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 62 · 🔀 510 · 📥 23 · 📦 3.2K · 📋 340 - 40% open · ⏱️ 28.03.2024):
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 460K · ⏱️ 05.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 870 / month):
	```
...
<details><summary><b><a href="https://github.com/nicolaskruchten/jupyter_pivottablejs">pivottablejs</a></b> (🥉20 ·  ⭐ 650 · 💀) - Dragndrop Pivot Tables and Charts for Jupyter/IPython.. <code>❗Unlicensed</code></summary>
...
- [Conda](https://anaconda.org/conda-forge/ipysheet) (📥 110K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysheet) (📥 760 / month):
	```
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 160 · 📦 2 · 📋 120 - 54% open · ⏱️ 01.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/witwidget) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/pbugnion/gmaps) (👨‍💻 16 · 🔀 150 · 📦 4 · 📋 210 - 35% open · ⏱️ 22.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/gmaps) (📥 5.8K / month):
	```
	pip install gmaps
	```
- [Conda](https://anaconda.org/conda-forge/gmaps) (📥 310K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-gmaps) (📥 840 / month):
	```
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 32 · 🔀 56 · 📦 41 · 📋 980 - 32% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/medialab/ipysigma) (👨‍💻 6 · 🔀 12 · 📦 28 · 📋 200 - 23% open · ⏱️ 20.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 890 / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets-contrib/ipytree) (👨‍💻 9 · 🔀 29 · 📋 40 - 50% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 85K / month):
	```
	pip install ipytree
	```
...
- [GitHub](https://github.com/vidartf/ipyscales) (👨‍💻 4 · 🔀 4 · 📦 58 · 📋 6 - 33% open · ⏱️ 01.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipyscales) (📥 54 / month):
	```
...
- [GitHub](https://github.com/CermakM/jupyter-datatables) (👨‍💻 4 · 🔀 27 · 📋 28 - 46% open · ⏱️ 11.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-datatables) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/nipy/niwidgets) (👨‍💻 16 · 🔀 33 · 📦 32 · 📋 34 - 50% open · ⏱️ 24.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/niwidgets) (📥 89 / month):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 21 · 📦 8 · ⏱️ 20.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 45K / month):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 1 · ⏱️ 10.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/tributary) (📥 280 / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 4 · 🔀 13 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 270 / month):
	```
...
- [GitHub](https://github.com/DGothrek/ipyaggrid) (👨‍💻 2 · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 6.9K / month):
	```
	pip install ipyaggrid
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 660 / month):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 140 · 🔀 790 · 📦 20 · 📋 810 - 42% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_contrib_nbextensions) (📥 500K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 100 · 🔀 290 · 📥 340 · 📦 530 · 📋 900 - 26% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/jupyter/nbgrader
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/Jupyter-contrib/jupyter_nbextensions_configurator) (👨‍💻 24 · 🔀 120 · 📦 580 · 📋 100 - 64% open · ⏱️ 29.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_nbextensions_configurator) (📥 590K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 34 · 🔀 98 · 📥 270 · 📦 580 · 📋 90 - 47% open · ⏱️ 12.03.2024):

	```
	git clone https://github.com/jupyter-server/jupyter-resource-usage
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 55K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 22 · 🔀 79 · 📦 49 · 📋 82 - 41% open · ⏱️ 13.03.2024):

	```
	git clone https://github.com/jupyterhub/jupyter-rsession-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 24K / month):
	```
...
- [GitHub](https://github.com/8080labs/pyforest) (👨‍💻 13 · 🔀 200 · 📋 27 - 48% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyforest) (📥 4K / month):
	```
...
- [GitHub](https://github.com/krishnan-r/sparkmonitor) (👨‍💻 3 · 🔀 49 · 📥 2.5K · 📋 22 - 68% open · ⏱️ 16.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/sparkmonitor) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 18 · 📦 400 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 21K / month):
	```
	pip install nbzip
	```
</details>
...
<details><summary><b><a href="https://github.com/googlecolab/jupyter_http_over_ws">HTTP-over-WebSocket</a></b> (🥉16 ·  ⭐ 270 · 💀) - Jupyter support for HTTP-over-ws. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jupyter-incubator/contentmanagement) (👨‍💻 8 · 🔀 26 · 📦 15 · 📋 27 - 25% open · ⏱️ 11.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_cms) (📥 80 / month):
	```
...
- [GitHub](https://github.com/lspvic/jupyter_tensorboard) (👨‍💻 4 · 🔀 70 · 📋 69 - 57% open · ⏱️ 16.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-tensorboard) (📥 5.5K / month):
	```
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 64 · 🔀 410 · 📦 340 · 📋 430 - 30% open · ⏱️ 13.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/sparkmagic) (📥 54K / month):
	```
...
- [GitHub](https://github.com/csurfer/blackcellmagic) (👨‍💻 3 · 🔀 13 · 📦 230 · 📋 10 - 50% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/blackcellmagic) (📥 1.2K / month):
	```
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 140K / month):
	```
	pip install pick
	```
</details>
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 4 · 🔀 40 · 📋 16 - 6% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 43 / month):
	```
	pip install py_d3
	```
</details>
...
- [GitHub](https://github.com/tmthyjames/SQLCell) (👨‍💻 14 · 🔀 11 · 📦 1 · 📋 84 - 71% open · ⏱️ 06.10.2020):
...
<details><summary><b><a href="https://github.com/ipython/ipykernel">IPython Kernel</a></b> (🥇34 ·  ⭐ 600 · 📈) - IPython Kernel for Jupyter. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 180 · 🔀 350 · 📥 2.2K · 📦 350K · 📋 490 - 50% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/ipython/ipykernel
	```
- [PyPi](https://pypi.org/project/ipykernel) (📥 27M / month):
	```
...
<details><summary><b><a href="https://github.com/Calysto/metakernel">Metakernel</a></b> (🥇24 ·  ⭐ 330) - Jupyter/IPython Kernel Tools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 34 · 🔀 86 · 📥 160 · 📦 860 · 📋 150 - 20% open · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/apache/incubator-toree) (👨‍💻 110 · 🔀 220 · ⏱️ 26.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/toree) (📥 7.5K / month):
	```
	pip install toree
	```
</details>
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 20 · 🔀 64 · 📥 160 · 📦 72 · 📋 180 - 18% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/calysto/octave_kernel
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 9.9K / month):
	```
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 33 · 📦 160 · 📋 42 - 52% open · ⏱️ 20.09.2018):
...
- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 120 · 🔀 210 · 📥 35K · 📋 560 - 11% open · ⏱️ 09.03.2024):
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 47 · 🔀 120 · 📥 180 · 📋 180 - 8% open · ⏱️ 12.03.2024):

	```
	git clone https://github.com/jupyter/kernel_gateway
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 33K / month):
	```
...
- [GitHub](https://github.com/Cadair/jupyter_environment_kernels) (👨‍💻 8 · 🔀 17 · 📦 5 · 📋 30 - 23% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/environment_kernels) (📥 29K / month):
	```
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 76 · 🔀 120 · 📥 850 · 📋 1.8K - 54% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/lfortran/lfortran
	```
- [PyPi](https://pypi.org/project/lfortran) (📥 67 / month):
	```
...
<details><summary><b><a href="https://github.com/pprzetacznik/IElixir">IElixir</a></b> (🥉15 ·  ⭐ 360) - Jupyter's kernel for Elixir programming language. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 11 · 🔀 82 · 📋 59 - 1% open · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/WolframResearch/WolframLanguageForJupyter) (👨‍💻 7 · 🔀 110 · 📥 9.4K · 📋 110 - 32% open · ⏱️ 19.02.2022):
...
<details><summary><b><a href="https://github.com/NII-cloud-operation/sshkernel">SSH Kernel</a></b> (🥉13 ·  ⭐ 65 · 💀) - SSH Kernel for Jupyter. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 270 · 🔀 530 · 📥 1.1K · 📦 260K · 📋 1.2K - 44% open · ⏱️ 21.03.2024):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 68 · 🔀 480 · 📥 1.1K · 📦 11K · 📋 710 - 39% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 50 · 🔀 150 · 📥 120 · 📦 140 · 📋 340 - 21% open · ⏱️ 21.11.2023):
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 73 · 🔀 660 · 📦 21 · 📋 290 - 42% open · ⏱️ 17.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/knowledge-repo) (📥 570 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbviewer) (👨‍💻 96 · 🔀 530 · 📦 18 · 📋 590 - 30% open · ⏱️ 27.01.2023):
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 44 · 🔀 43 · 📥 4.3K · 📦 20 · 📋 720 - 13% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 26 · 📦 340 · 📋 50 - 48% open · ⏱️ 13.04.2022):
...
- [GitHub](https://github.com/nteract/bookstore) (👨‍💻 7 · 🔀 20 · 📦 17 · 📋 73 - 46% open · ⏱️ 09.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/bookstore) (📥 870 / month):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 65 · 📦 2 · 📋 92 - 57% open · ⏱️ 28.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 80 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 80 · 🔀 150 · 📥 250 · 📦 270K · 📋 140 - 42% open · ⏱️ 15.03.2024):

	```
	git clone https://github.com/jupyter/nbformat
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 24M / month):
	```
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 47 · 🔀 460 · 📋 850 - 15% open · ⏱️ 04.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 67K / month):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 120 · 🔀 340 · 📦 200 · 📋 520 - 30% open · ⏱️ 24.03.2024):
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 33 · 🔀 46 · 📦 2.9K · 📋 110 - 37% open · ⏱️ 04.03.2024):
...
- [Conda](https://anaconda.org/conda-forge/beakerx) (📥 620K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/beakerx) (📥 150 / month):
	```
	npm install beakerx
	```
...
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥈22 ·  ⭐ 950) - Run any standard Python code quality tool on a Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 27 · 🔀 38 · 📋 290 - 2% open · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/jupyter/jupyter-sphinx) (👨‍💻 28 · 🔀 60 · 📋 150 - 28% open · ⏱️ 23.03.2024):
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 5 · 🔀 23 · 📦 100 · 📋 13 - 23% open · ⏱️ 04.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 33K / month):
	```
	pip install treon
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyter-naas/naas">naas</a></b> (🥉15 ·  ⭐ 270) - Schedule notebooks, run them like APIs, expose securely your assets:.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/tweag/jupyenv">JupyterWith</a></b> (🥉13 ·  ⭐ 590) - declarative and reproducible Jupyter environments - powered by Nix. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/takluyver/jupyter_kernel_mgmt) (👨‍💻 74 · 🔀 8 · 📥 17 · 📋 25 - 44% open · ⏱️ 29.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-mgmt) (📥 68 / month):
	```
...
<details><summary><b><a href="https://github.com/stas00/ipyexperiments">ipyexperiments</a></b> (🥉11 ·  ⭐ 190) - jupyter/ipython experiment containers for GPU and.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 69 · 📦 1.4K · 📋 68 - 63% open · ⏱️ 29.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-drawio) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 55 · 📦 640 · 📋 28 - 71% open · ⏱️ 19.05.2020):
...
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 2.2K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/latex) (📥 370 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 30 · 🔀 73 · 📋 110 - 32% open · ⏱️ 20.03.2024):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 490 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-chart-editor) (👨‍💻 5 · 🔀 24 · 📦 7 · 📋 31 - 38% open · ⏱️ 10.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-chart-editor) (📥 400 / month):
	```
...
- [GitHub](https://github.com/quigleyj97/jupyterlab-spreadsheet) (👨‍💻 4 · 🔀 16 · 📦 6 · 📋 27 - 33% open · ⏱️ 18.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-spreadsheet) (📥 830 / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 35 · 📦 3 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 27 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 28 · 📦 1.3K · 📋 25 - 32% open · ⏱️ 20.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 94 / month):
	```
	npm install @telamonian/theme-darcula
	```
</details>
<details><summary><b><a href="https://github.com/AllanChain/jupyterlab-theme-solarized-dark">jupyterlab-theme-solarized-dark</a></b> (🥈16 ·  ⭐ 91) - JupyterLab 2.x Solarized Dark extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/mohirio/jupyterlab-horizon-theme">Horizon Theme</a></b> (🥈16 ·  ⭐ 84) - VSCode Horizon Theme port for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mohirio/jupyterlab-horizon-theme) (👨‍💻 3 · 🔀 9 · 📥 42 · 📦 3 · 📋 9 - 11% open · ⏱️ 22.11.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@mohirio/jupyterlab-horizon-theme) (📥 210 / month):
	```
...
- [GitHub](https://github.com/yeebc/jupyterlab-neon-theme) (👨‍💻 4 · 🔀 9 · 📦 4 · 📋 13 - 15% open · ⏱️ 28.08.2022):

	```
	git clone https://github.com/yeebc/jupyterlab-neon-theme
	```
- [NPM](https://www.npmjs.com/package/@yeebc/jupyterlab_neon_theme) (📥 990 / month):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 17 · 📦 8 · 📋 18 - 16% open · ⏱️ 16.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 59 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-theme-toggle) (👨‍💻 2 · 🔀 3 · 📦 5 · 📋 5 - 20% open · ⏱️ 16.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-toggle) (📥 440 / month):
	```
...
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥇26 ·  ⭐ 7.4K) - Streaming pivot visualization via WebAssembly. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/finos/jupyterlab_templates) (👨‍💻 21 · 🔀 63 · 📦 8 · 📋 91 - 8% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/jpmorganchase/jupyterlab_templates
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 20K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab-variableInspector">Variable Inspector</a></b> (🥈19 ·  ⭐ 1.1K) - Variable Inspector extension for Jupyterlab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-variableInspector) (👨‍💻 22 · 🔀 87 · 📥 57 · 📦 6 · 📋 170 - 23% open · ⏱️ 21.02.2024):

	```
	git clone https://github.com/lckr/jupyterlab-variableInspector
	```
- [NPM](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 21 · 🔀 71 · 📦 3 · 📋 77 - 45% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/rapidsai/jupyterlab-nvdashboard
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 8.7K / month):
	```
...
- [GitHub](https://github.com/dask/dask-labextension) (👨‍💻 24 · 🔀 60 · 📦 3 · 📋 150 - 30% open · ⏱️ 04.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/dask-labextension) (📥 9.3K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/dask-labextension) (📥 950K · ⏱️ 04.08.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/dask-labextension) (📥 280 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-github) (👨‍💻 18 · 🔀 99 · 📥 30 · 📦 6 · 📋 62 - 33% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/jupyterlab/jupyterlab-github
	```
- [PyPi](https://pypi.org/project/jupyterlab-github) (📥 2.9K / month):
	```
	pip install jupyterlab-github
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/github) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/sidecar) (📥 7.8K / month):
	...
	pip install sidecar
	```
- [NPM](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-sidecar) (📥 140 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 15 · 🔀 33 · 📦 5 · 📋 76 - 22% open · ⏱️ 11.11.2023):

	```
	git clone https://github.com/jpmorganchase/jupyter-fs
	```
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 1K / month):
	```
...
- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 3 · 🔀 21 · 📦 19 · 📋 200 - 2% open · ⏱️ 05.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/pylantern) (📥 78 / month):
	```
	pip install pylantern
	```
</details>
<details><summary><b><a href="https://github.com/deshaw/jupyterlab-execute-time">jupyterlab-execute-time</a></b> (🥈16 ·  ⭐ 330) - Execute Time Plugin for Jupyter Lab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 19 · 🔀 46 · 📦 3 · 📋 100 - 16% open · ⏱️ 18.03.2024):
...
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 37K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 4.1K / month):
	```
...
- [GitHub](https://github.com/jwkvam/jupyterlab-vim) (👨‍💻 8 · 🔀 73 · 📦 3 · 📋 100 - 55% open · ⏱️ 16.07.2019):

	```
	git clone https://github.com/jwkvam/jupyterlab-vim
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_vim) (📥 130 / month):
	```
...
- [GitHub](https://github.com/chesterli29/jupyterlab_tensorboard) (👨‍💻 7 · 🔀 33 · 📦 5 · 📋 30 - 66% open · ⏱️ 18.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_tensorboard) (📥 7.9K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-data-explorer">JupyterLab Data Explorer</a></b> (🥉14 ·  ⭐ 180 · 💤) - First class datasets in JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-data-explorer) (👨‍💻 10 · 🔀 36 · 📦 14 · ⏱️ 08.08.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/dataregistry-extension) (📥 18 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-hdf5) (👨‍💻 9 · 🔀 25 · 📦 3 · 📋 50 - 28% open · ⏱️ 11.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 450 / month):
	```
	pip install jupyterlab_hdf
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 60 / month):
	```
	npm install @jupyterlab/hdf5
	```
</details>
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥉14 ·  ⭐ 89) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/microsoft/gather) (👨‍💻 13 · 🔀 35 · 📦 3 · 📋 28 - 35% open · ⏱️ 28.11.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 19 / month):
	```
...
- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 8 · 📋 33 - 33% open · ⏱️ 22.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 320 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-commenting) (👨‍💻 10 · 🔀 22 · 📦 3 · 📋 35 - 71% open · ⏱️ 01.05.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/commenting-extension) (📥 7 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📥 29 · 📦 7 · 📋 13 - 15% open · ⏱️ 08.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 58 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 5 · 🔀 2 · 📦 40 · ⏱️ 21.02.2024):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/mlshapiro/jupyterlab-flake8) (👨‍💻 5 · 🔀 10 · 📦 3 · 📋 41 - 19% open · ⏱️ 16.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-flake8) (📥 62 / month):
	```
	npm install jupyterlab-flake8
	```
</details>
<details><summary><b><a href="https://github.com/jtpio/jupyterlab-python-bytecode">JupyterLab Bytecode</a></b> (🥉10 ·  ⭐ 62 · 💀) - JupyterLab extension to explore CPython Bytecode. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 🔀 1 · 📥 4 · 📦 3 · 📋 3 - 33% open · ⏱️ 10.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 100 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@reviewnb/jupyterlab_gitplus) (📥 15 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 120 · 🔀 330 · 📦 410 · 📋 290 - 15% open · ⏱️ 23.03.2024):

	```
	git clone https://github.com/jupyterhub/oauthenticator
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📥 45K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 22 · 🔀 62 · 📦 75 · 📋 110 - 31% open · ⏱️ 06.02.2024):
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 18 · 🔀 49 · 📦 110 · 📋 50 - 6% open · ⏱️ 06.03.2024):

	```
	git clone https://github.com/jupyterhub/ltiauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-ltiauthenticator) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 29 · 📦 98 · 📋 26 - 34% open · ⏱️ 30.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 8.9K / month):
	```
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 7 · 🔀 22 · 📥 13 · 📋 32 - 53% open · ⏱️ 21.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 960 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 7 · 🔀 10 · 📦 110 · ⏱️ 17.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/nullauthenticator) (📥 5K / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 26 · 📋 19 - 42% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 950 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kerberosauthenticator) (👨‍💻 2 · 🔀 5 · 📋 5 - 60% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kerberosauthenticator) (📥 360 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 69 · 🔀 290 · 📦 180 · 📋 280 - 8% open · ⏱️ 01.02.2024):

	```
	git clone https://github.com/jupyterhub/dockerspawner
	```
- [PyPi](https://pypi.org/project/dockerspawner) (📥 67K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 84 · 🔀 280 · 📦 160 · 📋 360 - 20% open · ⏱️ 28.03.2024):
...
<details><summary><b><a href="https://github.com/jupyterhub/batchspawner">BatchSpawner</a></b> (🥈20 ·  ⭐ 170) - Custom Spawner for Jupyterhub to start servers in batch scheduled.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 49 · 🔀 120 · 📦 34 · 📋 140 - 37% open · ⏱️ 19.03.2024):
...
- [GitHub](https://github.com/uktrade/fargatespawner) (👨‍💻 3 · 🔀 21 · 📦 4 · 📋 11 - 54% open · ⏱️ 28.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/fargatespawner) (📥 510 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 12 · 📋 11 - 63% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 130 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 980 · 🔀 4.3K · 📥 320K · 📦 520K · 📋 7.3K - 22% open · ⏱️ 17.03.2024):

	```
	git clone https://github.com/ipython/ipython
	```
- [PyPi](https://pypi.org/project/ipython) (📥 44M / month):
	```
	pip install ipython
	```
...
- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 120 · 🔀 190 · 📦 170K · 📋 340 - 31% open · ⏱️ 25.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/qtconsole) (📥 5.5M / month):
	```
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 170 · 🔀 440 · 📦 11K · 📋 3.3K - 29% open · ⏱️ 27.03.2024):
