...
- [GitHub](https://github.com/jupyterlab/jupyterlab) (👨‍💻 470 · 🔀 2.2K · 📥 40K · 📦 58K · 📋 6.5K - 30% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/jupyterlab/jupyterlab
	```
- [PyPi](https://pypi.org/project/jupyterlab) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 270 · 🔀 1.6K · 📦 1.7K · 📋 2.1K - 8% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/jupyterhub/jupyterhub
	```
- [PyPi](https://pypi.org/project/jupyterhub) (📥 540K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/notebook">Jupyter</a></b> (🥈25 ·  ⭐ 9.8K · 📉) - Jupyter Interactive Notebook. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 600 · 🔀 3.6K · 📥 5.6K · 📋 4.4K - 46% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/jupyter/notebook
	```
- [PyPi](https://pypi.org/project/notebook) (📥 9M / month):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 220 · 🔀 2.5K · 📋 730 - 5% open · ⏱️ 08.03.2022):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 170 · 🔀 520 · 📥 1.3M · 📋 1.7K - 9% open · ⏱️ 06.03.2022):
...
<details><summary><b><a href="https://github.com/googledatalab/datalab">DataLab</a></b> (🥉21 ·  ⭐ 970 · 💤) - Interactive tools and developer experiences for Big Data on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ml-tooling/ml-workspace) (👨‍💻 10 · 🔀 310 · 📋 78 - 7% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 140 · 🔀 780 · 📋 280 - 5% open · ⏱️ 26.02.2022):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 40 · 📥 670 · 📦 54 · 📋 140 - 31% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/jtpio/jupyterlab-classic
	```
- [PyPi](https://pypi.org/project/jupyterlab-classic) (📥 420 / month):
	```
...
<details><summary><b><a href="https://github.com/microsoft/vscode-jupyter">VSCode Jupyter</a></b> (🥉16 ·  ⭐ 560) - VS Code Jupyter extension. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 600 · 🔀 3.8K · 📦 47K · 📋 6.8K - 9% open · ⏱️ 09.03.2022):
...
<details><summary><b><a href="https://github.com/ydataai/pandas-profiling">pandas-profiling</a></b> (🥇32 ·  ⭐ 8.6K) - Create HTML profiling reports from pandas DataFrame.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 190 · 🔀 780 · 📦 3.4K · 📋 1.7K - 31% open · ⏱️ 08.03.2022):

	```
	git clone https://github.com/jupyter-widgets/ipywidgets
	```
- [PyPi](https://pypi.org/project/ipywidgets) (📥 7.9M / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 74 · 🔀 300 · 📦 1.5K · 📋 470 - 37% open · ⏱️ 17.02.2022):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 63K / month):
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 26 · 🔀 180 · 📦 2.7K · 📋 240 - 43% open · ⏱️ 21.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 88K / month):
	```
	pip install ipympl
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 56 · 🔀 430 · 📦 30 · 📋 560 - 36% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 75K / month):
	```
	pip install bqplot
	```
...
<details><summary><b><a href="https://github.com/man-group/dtale">D-Tale</a></b> (🥈27 ·  ⭐ 3.2K) - Visualizer for Pandas Data Structures. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/man-group/dtale) (👨‍💻 23 · 🔀 240 · 📦 300 · 📋 450 - 10% open · ⏱️ 10.03.2022):
...
- [PyPi](https://pypi.org/project/dtale) (📥 73K / month):
	...
	pip install dtale
	```
- [Conda](https://anaconda.org/conda-forge/dtale) (📥 110K · ⏱️ 20.02.2022):
	```
...
- [GitHub](https://github.com/nteract/papermill) (👨‍💻 98 · 🔀 340 · 📦 2K · 📋 330 - 29% open · ⏱️ 18.02.2022):

	```
	git clone https://github.com/nteract/papermill
	```
- [PyPi](https://pypi.org/project/papermill) (📥 490K / month):
	```
...
- [GitHub](https://github.com/widgetti/ipyvolume) (👨‍💻 39 · 🔀 210 · 📦 710 · 📋 290 - 56% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 5 · 🔀 180 · 📥 75 · 📦 1.3K · 📋 52 - 67% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/plotly/jupyter-dash
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 65K / month):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 15 · 🔀 47 · 📦 410 · 📋 100 - 35% open · ⏱️ 08.03.2022):
...
- [GitHub](https://github.com/cytoscape/ipycytoscape) (👨‍💻 31 · 🔀 48 · 📥 3 · 📦 61 · 📋 150 - 34% open · ⏱️ 07.03.2022):
...
- [GitHub](https://github.com/quantopian/qgrid) (👨‍💻 30 · 🔀 370 · 📋 270 - 54% open · ⏱️ 07.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/qgrid) (📥 46K / month):
	```
	pip install qgrid
	```
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 330K · ⏱️ 04.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 790 / month):
	```
	npm install qgrid
	```
</details>
...
- [GitHub](https://github.com/mwouts/itables) (👨‍💻 3 · 🔀 22 · 📦 100 · 📋 35 - 22% open · ⏱️ 24.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/itables) (📥 5.7K / month):
	```
	pip install itables
	```
</details>
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 10 · 🔀 59 · 📦 3 · 📋 120 - 50% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipysheet) (📥 30K / month):
	```
...
<details><summary><b><a href="https://github.com/InsightSoftwareConsortium/itkwidgets">itkwidgets</a></b> (🥉19 ·  ⭐ 420) - Interactive Jupyter widgets to visualize images, point sets, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 20 · 🔀 52 · 📥 64 · 📋 170 - 42% open · ⏱️ 17.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 8 · 📋 6 - 33% open · ⏱️ 14.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 620K / month):
	```
...
- [GitHub](https://github.com/pbugnion/gmaps) (👨‍💻 16 · 🔀 140 · 📦 1 · 📋 200 - 31% open · ⏱️ 22.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/gmaps) (📥 14K / month):
	```
	pip install gmaps
	```
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 11 · 🔀 55 · 📋 92 - 10% open · ⏱️ 01.03.2022):
...
<details><summary><b><a href="https://github.com/timkpaine/tributary">tributary</a></b> (🥉18 ·  ⭐ 300) - Streaming reactive and dataflow graphs in Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 25 · 📦 17 · 📋 80 - 10% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/timkpaine/tributary
	```
- [PyPi](https://pypi.org/project/tributary) (📥 500 / month):
	```
...
- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 3 · 🔀 5 · 📦 9 · 📋 19 - 26% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/timkpaine/ipydagred3
	```
- [PyPi](https://pypi.org/project/ipydagred3) (📥 780 / month):
	```
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 450 · 📋 9 - 33% open · ⏱️ 04.01.2021):
...
- [GitHub](https://github.com/g2nb/igv-jupyter) (👨‍💻 5 · 🔀 14 · 📦 7 · ⏱️ 17.02.2022):
...
- [GitHub](https://github.com/QuantStack/ipytree) (👨‍💻 8 · 🔀 23 · 📋 30 - 56% open · ⏱️ 10.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 14K / month):
	```
	pip install ipytree
	```
...
<details><summary><b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉16 ·  ⭐ 71 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/spacetelescope/jdaviz">jdaviz</a></b> (🥉16 ·  ⭐ 53) - JWST astronomical data analysis tools in the Jupyter platform. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 25 · 🔀 26 · 📋 520 - 41% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/spacetelescope/jdaviz
	```
- [PyPi](https://pypi.org/project/jdaviz) (📥 360 / month):
	```
	pip install jdaviz
	```
</details>
...
- [GitHub](https://github.com/vidartf/ipyscales) (👨‍💻 4 · 🔀 3 · 📦 51 · 📋 6 - 33% open · ⏱️ 05.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyscales) (📥 230 / month):
	```
...
<details><summary><b><a href="https://github.com/maartenbreddels/ipymaterialui">ipymaterialui</a></b> (🥉14 ·  ⭐ 78 · 💀) - Jupyter Widgets based on React Material UI components. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/maartenbreddels/ipymaterialui) (👨‍💻 3 · 🔀 14 · 📦 4 · 📋 10 - 70% open · ⏱️ 29.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipymaterialui) (📥 150 / month):
	```
...
- [GitHub](https://github.com/leifwalsh/perfume) (👨‍💻 3 · 🔀 4 · 📋 6 - 33% open · ⏱️ 31.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/perfume-bench) (📥 230 / month):
	```
	pip install perfume-bench
	```
</details>
<details><summary><b><a href="https://github.com/medialab/ipysigma">ipysigma</a></b> (🥉12 ·  ⭐ 31) - A custom Jupyter widget library to display graphs using sigma.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/ipysigma) (📥 680 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 180 / month):
	```
...
- [GitHub](https://github.com/CermakM/jupyter-datatables) (👨‍💻 4 · 🔀 14 · 📋 28 - 46% open · ⏱️ 11.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-datatables) (📥 700 / month):
	```
...
- [GitHub](https://github.com/jtpio/ipyp5) (👨‍💻 2 · 🔀 5 · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyp5) (📥 90 / month):
	```
	pip install ipyp5
	```
</details>
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 3 · 🔀 2 · 📦 1 · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 2.8K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 930 / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 3 · 🔀 10 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 110 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 84 · 🔀 270 · 📋 780 - 25% open · ⏱️ 18.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 61 · 🔀 100 · 📦 4 · 📋 150 - 39% open · ⏱️ 28.02.2022):

	```
	git clone https://github.com/jupyterhub/jupyter-server-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 490K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 24 · 🔀 54 · 📦 440 · 📋 120 - 39% open · ⏱️ 29.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbgitpuller) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 130 · 🔀 750 · 📋 760 - 41% open · ⏱️ 06.04.2021):
...
- [GitHub](https://github.com/oschuett/appmode) (👨‍💻 8 · 🔀 66 · 📦 300 · 📋 52 - 5% open · ⏱️ 26.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/appmode) (📥 3.1K / month):
	```
	pip install appmode
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 20 · 🔀 66 · 📥 12 · 📋 55 - 50% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 17K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 19 · 🔀 59 · 📦 37 · 📋 67 - 37% open · ⏱️ 22.12.2021):

	```
	git clone https://github.com/jupyterhub/jupyter-rsession-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/googlecolab/jupyter_http_over_ws) (👨‍💻 3 · 🔀 36 · 📋 27 - 74% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 13K / month):
	```
...
- [GitHub](https://github.com/mozilla/jupyter-spark) (👨‍💻 12 · 🔀 30 · 📦 16 · 📋 27 - 48% open · ⏱️ 01.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-spark) (📥 930 / month):
	```
...
- [GitHub](https://github.com/data-8/nbzip) (👨‍💻 6 · 🔀 15 · 📦 260 · 📋 14 - 64% open · ⏱️ 22.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/nbzip) (📥 860 / month):
	```
	pip install nbzip
	```
</details>
...
- [GitHub](https://github.com/jupyter-incubator/contentmanagement) (👨‍💻 8 · 🔀 25 · 📋 27 - 25% open · ⏱️ 11.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_cms) (📥 300 / month):
	```
...
<details><summary><b><a href="https://github.com/paypal/PPExtensions">PPExtensions</a></b> (🥉10 ·  ⭐ 49 · 💀) - Set of iPython and Jupyter extensions to improve user.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/paypal/PPExtensions) (👨‍💻 9 · 🔀 26 · 📦 1 · 📋 38 - 42% open · ⏱️ 07.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/ppextensions) (📥 160 / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 44 · 🔀 230 · 📦 2.8K · 📋 140 - 72% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/csurfer/pyheatmagic) (👨‍💻 3 · 🔀 22 · 📦 25 · 📋 5 - 40% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat-magic) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/ShopRunner/jupyter-notify) (👨‍💻 11 · 🔀 33 · 📋 22 - 50% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyternotify) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/csurfer/blackcellmagic) (👨‍💻 3 · 🔀 9 · 📦 140 · 📋 8 - 37% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/blackcellmagic) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/tmthyjames/SQLCell) (👨‍💻 14 · 🔀 9 · 📦 1 · 📋 84 - 71% open · ⏱️ 06.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/sqlcell) (📥 260 / month):
	```
	pip install sqlcell
	```
</details>
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 7 · 📋 9 - 44% open · ⏱️ 04.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 33K / month):
	```
	pip install pick
	```
</details>
...
<details><summary><b><a href="https://github.com/ipython/ipykernel">IPython Kernel</a></b> (🥇29 ·  ⭐ 460) - IPython Kernel for Jupyter. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 280 · 📥 300 · 📦 160K · 📋 390 - 51% open · ⏱️ 28.02.2022):
...
- [PyPi](https://pypi.org/project/ipykernel) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/anaconda/ipykernel) (📥 250K · ⏱️ 05.03.2022):
	```
...
- [GitHub](https://github.com/gopherdata/gophernotes) (👨‍💻 28 · 🔀 210 · 📥 40 · 📦 7 · 📋 170 - 27% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 15 · 🔀 140 · 📦 57 · 📋 220 - 21% open · ⏱️ 24.01.2022):

	```
	git clone https://github.com/n-riesco/ijavascript
	```
- [NPM](https://www.npmjs.com/package/ijavascript) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 29 · 🔀 75 · 📥 21 · 📋 140 - 19% open · ⏱️ 02.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 38K / month):
	```
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 24 · 📦 72 · 📋 35 - 48% open · ⏱️ 20.09.2018):

	```
	git clone https://github.com/Valassis-Digital-Media/spylon-kernel
	```
- [PyPi](https://pypi.org/project/spylon-kernel) (📥 10K / month):
	```
	pip install spylon-kernel
	```
- [Conda](https://anaconda.org/conda-forge/spylon-kernel) (📥 82K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/gibiansky/IHaskell) (👨‍💻 110 · 🔀 240 · 📋 720 - 4% open · ⏱️ 01.03.2022):
...
<details><summary><b><a href="https://github.com/SciRuby/iruby">IRuby</a></b> (🥈18 ·  ⭐ 690) - Official gem repository: Ruby kernel for Jupyter/IPython Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ansible/ansible-jupyter-kernel) (👨‍💻 10 · 🔀 51 · 📦 8 · 📋 42 - 30% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ansible-kernel) (📥 660 / month):
	```
...
<details><summary><b><a href="https://github.com/Anaconda-Platform/nb_conda_kernels">nb_conda_kernels</a></b> (🥈18 ·  ⭐ 440 · 💀) - Package for managing conda environment-based kernels.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 71 · 📋 55 - 3% open · ⏱️ 21.09.2021):

	```
	git clone https://github.com/sassoftware/sas_kernel
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/scijava/scijava-jupyter-kernel) (👨‍💻 9 · 🔀 43 · 📥 80 · ⏱️ 03.02.2022):
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 44 · 🔀 110 · 📥 100 · 📋 180 - 7% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 8.8K / month):
	```
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 21 · 🔀 15 · ⏱️ 09.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/lfortran) (📥 210 / month):
	```
...
- [GitHub](https://github.com/SpencerPark/IJava) (👨‍💻 4 · 🔀 140 · 📥 74K · 📋 120 - 52% open · ⏱️ 08.12.2019):
...
- [GitHub](https://github.com/clojupyter/clojupyter) (👨‍💻 26 · 🔀 73 · 📋 95 - 16% open · ⏱️ 29.12.2021):
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 10 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 470 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 240 · 🔀 460 · 📦 140K · 📋 960 - 40% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 340 · 📦 410 · 📋 2.1K - 1% open · ⏱️ 08.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/nikola) (📥 3.4K / month):
	```
	pip install nikola
	```
</details>
<details><summary><b><a href="https://github.com/mwouts/jupytext">Jupytext</a></b> (🥇27 ·  ⭐ 5.2K) - Jupyter Notebooks as Markdown Documents, Julia, Python or R scripts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 68 · 🔀 320 · 📦 2.5K · 📋 500 - 12% open · ⏱️ 10.02.2022):

	```
	git clone https://github.com/mwouts/jupytext
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 230K / month):
	```
...
<details><summary><b><a href="https://github.com/voila-dashboards/voila">Voila</a></b> (🥈25 ·  ⭐ 4K) - Voil turns Jupyter notebooks into standalone web applications. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 57 · 🔀 380 · 📥 160 · 📦 6.2K · 📋 570 - 40% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 53K / month):
	```
	pip install voila
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 100 · 🔀 430 · 📋 1K - 38% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/executablebooks/jupyter-book
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 44K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 35 · 🔀 120 · 📦 65 · 📋 280 - 21% open · ⏱️ 28.02.2022):
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 32 · 🔀 33 · 📥 1.4K · 📦 16 · 📋 550 - 10% open · ⏱️ 02.03.2022):
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 65 · 🔀 640 · 📋 280 - 41% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/nteract/bookstore) (👨‍💻 7 · 🔀 18 · 📦 8 · 📋 73 - 46% open · ⏱️ 09.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/bookstore) (📥 440K / month):
	```
...
- [GitHub](https://github.com/aaren/notedown) (👨‍💻 7 · 🔀 91 · 📦 170 · 📋 68 - 57% open · ⏱️ 16.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/notedown) (📥 3.6K / month):
	```
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 24 · 📦 94 · 📋 48 - 47% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 12 · 🔀 14 · 📋 38 - 7% open · ⏱️ 14.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 28K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/nbformat">nbformat</a></b> (🥇29 ·  ⭐ 170) - Reference implementation of the Jupyter Notebook format. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥇28 ·  ⭐ 85) - A client library for executing notebooks. Formally nbconvert's.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 30 · 🔀 39 · 📥 27 · 📦 46K · 📋 81 - 29% open · ⏱️ 06.03.2022):

	```
	git clone https://github.com/jupyter/nbclient
	```
- [PyPi](https://pypi.org/project/nbclient) (📥 9.1M / month):
	```
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 63 · 🔀 330 · 📋 360 - 23% open · ⏱️ 03.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 93K / month):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 110 · 🔀 830 · 📦 1.8K · 📋 310 - 14% open · ⏱️ 01.03.2022):

	```
	git clone https://github.com/ipython/ipyparallel
	```
- [PyPi](https://pypi.org/project/ipyparallel) (📥 53K / month):
	```
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 29 · 🔀 39 · 📦 1.4K · 📋 96 - 36% open · ⏱️ 05.01.2022):

	```
	git clone https://github.com/computationalmodelling/nbval
	```
- [PyPi](https://pypi.org/project/nbval) (📥 87K / month):
	```
	pip install nbval
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 110 · 🔀 210 · 📥 170 · 📋 300 - 44% open · ⏱️ 07.03.2022):
...
- [GitHub](https://github.com/twosigma/beakerx) (👨‍💻 43 · 🔀 370 · 📥 31 · 📋 4.5K - 7% open · ⏱️ 21.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/beakerx) (📥 9.2K / month):
	```
	pip install beakerx
	```
- [Conda](https://anaconda.org/conda-forge/beakerx) (📥 490K · ⏱️ 18.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/beakerx) (📥 530 / month):
	```
	npm install beakerx
	```
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 110 · 🔀 280 · 📦 140 · 📋 460 - 30% open · ⏱️ 06.03.2022):

	```
	git clone https://github.com/jupyterhub/repo2docker
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 6.8K / month):
	```
...
<details><summary><b><a href="https://github.com/chmp/ipytest">ipytest</a></b> (🥉19 ·  ⭐ 210 · 📈) - Pytest in IPython notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 18 · 📦 150 · 📋 45 - 2% open · ⏱️ 20.02.2022):

	```
	git clone https://github.com/chmp/ipytest
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 7.5K / month):
	```
	pip install ipytest
	```
</details>
...
- [GitHub](https://github.com/QuantEcon/sphinxcontrib-jupyter) (👨‍💻 13 · 🔀 23 · 📦 24 · 📋 180 - 48% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinxcontrib-jupyter) (📥 1.5K / month):
	```
	pip install sphinxcontrib-jupyter
	```
</details>
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥉17 ·  ⭐ 440) - Run any standard Python code quality tool on a Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 18 · 🔀 25 · 📋 240 - 2% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/nbQA-dev/nbQA
	```
- [PyPi](https://pypi.org/project/nbqa) (📥 28K / month):
	```
	pip install nbqa
	```
</details>
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 19 · 📦 44 · 📋 11 - 18% open · ⏱️ 08.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 5.6K / month):
	```
	pip install treon
	```
</details>
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 15 · 🔀 13 · 📦 3 · 📋 120 - 59% open · ⏱️ 02.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/naas) (📥 23K / month):
	```
	pip install naas
	```
</details>
...
- [GitHub](https://github.com/nteract/testbook) (👨‍💻 14 · 🔀 25 · 📦 85 · 📋 80 - 43% open · ⏱️ 21.09.2021):
...
- [GitHub](https://github.com/takluyver/jupyter_kernel_mgmt) (👨‍💻 74 · 🔀 7 · 📥 17 · 📋 24 - 41% open · ⏱️ 29.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-mgmt) (📥 180 / month):
	```
...
- [GitHub](https://github.com/krassowski/jupyter-helpers) (👨‍💻 2 · 🔀 3 · 📋 5 - 60% open · ⏱️ 31.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_helpers) (📥 200 / month):
	```
...
- [GitHub](https://github.com/stas00/ipyexperiments) (👨‍💻 3 · 🔀 10 · 📦 5 · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyexperiments) (📥 910 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 56 · 📦 200 · 📋 28 - 71% open · ⏱️ 19.05.2020):
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 59 · 📦 210 · 📋 64 - 60% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/QuantStack/jupyterlab-drawio
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-drawio) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-chart-editor) (👨‍💻 5 · 🔀 20 · 📦 3 · 📋 31 - 38% open · ⏱️ 10.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-chart-editor) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/quigleyj97/jupyterlab-spreadsheet) (👨‍💻 4 · 🔀 12 · 📋 23 - 21% open · ⏱️ 20.11.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-spreadsheet) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 31 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 51 / month):
	```
...
<details><summary><b><a href="https://github.com/telamonian/theme-darcula">Darcula Theme</a></b> (🥇17 ·  ⭐ 140 · 💤) - A handsome Darcula theme for Jupyterlab. The first jlab.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 19 · 📦 190 · 📋 21 - 23% open · ⏱️ 26.08.2021):
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 14 · 📦 4 · 📋 17 - 17% open · ⏱️ 31.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 630 / month):
	```
...
<details><summary><b><a href="https://github.com/Rahlir/theme-gruvbox">Gruvbox Theme</a></b> (🥉8 ·  ⭐ 46 · 💀) - Gruvbox dark theme for Jupyter Lab. Modeled on classic.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/kenshohara/theme-nord-extension) (🔀 1 · 📋 5 - 20% open · ⏱️ 20.09.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@kenshohara/theme-nord-extension) (📥 30 / month):
	```
...
<details><summary><b><a href="https://github.com/finos/perspective">Perspective</a></b> (🥇25 ·  ⭐ 4.2K) - Streaming pivot visualization via WebAssembly. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/finos/perspective) (👨‍💻 67 · 🔀 440 · 📦 240 · 📋 500 - 12% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 9.4K / month):
	```
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 44 · 🔀 210 · 📦 29 · 📋 1.3K - 16% open · ⏱️ 09.03.2022):

	```
	git clone https://github.com/elyra-ai/elyra
	```
- [PyPi](https://pypi.org/project/elyra) (📥 4.6K / month):
	```
	pip install elyra
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 38 · 🔀 86 · 📦 120 · 📋 390 - 34% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/krassowski/jupyterlab-lsp
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 5K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 38 · 📋 260 - 6% open · ⏱️ 31.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 86K / month):
	```
...
- [GitHub](https://github.com/lckr/jupyterlab-variableInspector) (👨‍💻 17 · 🔀 78 · 📦 3 · 📋 150 - 25% open · ⏱️ 19.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 9.2K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-github) (👨‍💻 15 · 🔀 83 · 📦 2 · 📋 57 - 36% open · ⏱️ 10.12.2021):

	```
	git clone https://github.com/jupyterlab/jupyterlab-github
	```
- [PyPi](https://pypi.org/project/jupyterlab-github) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 30 · 🔀 38 · 📋 140 - 17% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 23K / month):
	```
	pip install jupyterlab_code_formatter
	```
- [NPM](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-google-drive) (👨‍💻 15 · 🔀 69 · 📦 2 · 📋 96 - 32% open · ⏱️ 10.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/google-drive) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 51 · 📦 4 · 📋 78 - 10% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 7.3K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/dask-labextension) (📥 500K · ⏱️ 08.01.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/dask-labextension) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/jwkvam/jupyterlab-vim) (👨‍💻 8 · 🔀 73 · 📦 3 · 📋 97 - 56% open · ⏱️ 16.07.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_vim) (📥 690 / month):
	```
...
- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 2 · 🔀 20 · 📦 14 · 📋 200 - 5% open · ⏱️ 05.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylantern) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/sidecar) (📥 5.5K / month):
	...
	pip install sidecar
	```
- [NPM](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-sidecar) (📥 630 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 6 · 🔀 16 · 📦 1 · 📋 46 - 28% open · ⏱️ 22.02.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 1.8K / month):
	```
	npm install @ijmbarr/jupyterlab_spellchecker
	```
</details>
<details><summary><b><a href="https://github.com/rapidsai/jupyterlab-nvdashboard">GPU Dashboards</a></b> (🥈16 ·  ⭐ 450) - A JupyterLab extension for displaying dashboards of GPU.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 15 · 🔀 52 · 📋 52 - 44% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/rapidsai/jupyterlab-nvdashboard
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 5.8K / month):
	```
	pip install jupyterlab-nvdashboard
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 15 · 📦 3 · 📋 64 - 9% open · ⏱️ 25.02.2022):
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 16 · 🔀 36 · 📋 81 - 3% open · ⏱️ 03.03.2022):

	```
	git clone https://github.com/bokeh/jupyter_bokeh
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 6.6K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-data-explorer">JupyterLab Data Explorer</a></b> (🥉15 ·  ⭐ 160 · 💀) - First class datasets in JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jtpio/ipylab">ipylab</a></b> (🥉15 ·  ⭐ 97) - Control JupyterLab from Python Notebooks with Jupyter Widgets. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 6 · 🔀 6 · 📥 30 · 📋 28 - 32% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 1.9K / month):
	```
	pip install ipylab
	```
...
- [GitHub](https://github.com/parente/jupyterlab-quickopen) (👨‍💻 5 · 🔀 6 · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 510 / month):
	```
	pip install jupyterlab-quickopen
	```
- [NPM](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 74 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥉14 ·  ⭐ 82) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 16 · 📋 110 - 26% open · ⏱️ 25.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 200 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 4 · 🔀 6 · 📋 29 - 17% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 300 / month):
	```
	pip install jupyterlab_autoversion
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_autoversion) (📥 58 / month):
	```
	npm install jupyterlab_autoversion
	```
</details>
<details><summary><b><a href="https://github.com/jtpio/jupyterlab-python-file">JupyterLab Python Files</a></b> (🥉13 ·  ⭐ 51 · 💤) - JupyterLab extension to create Python files. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-commenting">JupyterLab Commenting</a></b> (🥉12 ·  ⭐ 89 · 💀) - Commenting and annotation for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-commenting) (👨‍💻 10 · 🔀 22 · 📋 34 - 70% open · ⏱️ 01.05.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/commenting-extension) (📥 100 / month):
	```
	npm install @jupyterlab/commenting-extension
	```
</details>
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉12 ·  ⭐ 72 · 💤) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 9 · 🔀 19 · 📋 15 - 46% open · ⏱️ 04.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 680 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 36 - 11% open · ⏱️ 25.02.2022):

	```
	git clone https://github.com/timkpaine/jupyterlab_email
	```
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 240 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 36 - 11% open · ⏱️ 25.02.2022):
	...
	git clone https://github.com/timkpaine/jupyterlab_email
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-flake8) (📥 250 / month):
	```
...
- [GitHub](https://github.com/timkpaine/knowledgelab) (👨‍💻 3 · 🔀 6 · 📦 2 · 📋 27 - 11% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/knowledgelab) (📥 46 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 430 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@reviewnb/jupyterlab_gitplus) (📥 99 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 53 / month):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 74 / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 📥 3 · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 130 / month):
	```
	pip install jupyterlab-executor
	```
- [NPM](https://www.npmjs.com/package/@gavincyi/jupyterlab-executor) (📥 21 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 30 · 🔀 150 · 📦 88 · 📋 130 - 41% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/jupyterhub/ldapauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-ldapauthenticator) (📥 6.9K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/ltiauthenticator">LTI Authenticator</a></b> (🥈19 ·  ⭐ 52) - A JupyterHub authenticator for LTI. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 49 · 📦 34 · 📋 90 - 23% open · ⏱️ 30.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 21 · 📦 57 · 📋 22 - 22% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 5K / month):
	```
...
- [GitHub](https://github.com/mogthesprog/jwtauthenticator) (👨‍💻 7 · 🔀 35 · 📦 8 · 📋 17 - 52% open · ⏱️ 13.02.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-jwtauthenticator) (📥 500 / month):
	```
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 6 · 🔀 18 · 📥 13 · 📋 28 - 50% open · ⏱️ 25.08.2021):

	```
	git clone https://github.com/HewlettPackard/jupyterhub-samlauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 520 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 5 · 🔀 9 · 📦 74 · ⏱️ 09.02.2021):
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 25 · 📋 18 - 44% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 570 / month):
	```
...
- [GitHub](https://github.com/thedataincubator/jupyterhub-hashauthenticator) (👨‍💻 3 · 🔀 3 · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-hashauthenticator) (📥 130 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 66 · 🔀 230 · 📦 100 · 📋 280 - 18% open · ⏱️ 10.03.2022):

	```
	git clone https://github.com/jupyterhub/kubespawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 460K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 62 · 🔀 270 · 📦 120 · 📋 250 - 5% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/dockerspawner) (📥 7.9K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 38 · 🔀 92 · 📦 12 · 📋 120 - 39% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/jupyterhub/batchspawner
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 17 · 🔀 37 · 📦 20 · 📋 56 - 46% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-systemdspawner) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/wrapspawner) (👨‍💻 16 · 🔀 46 · 📦 5 · 📋 28 - 50% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/uktrade/fargatespawner) (👨‍💻 3 · 🔀 19 · 📦 1 · 📋 9 - 55% open · ⏱️ 28.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/fargatespawner) (📥 920 / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 880 · 🔀 4.2K · 📥 320K · 📦 260K · 📋 6.9K - 21% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 460 · 🔀 160 · 📥 270 · 📋 250 - 33% open · ⏱️ 09.03.2022):
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 23 · 🔀 39 · 📋 32 - 28% open · ⏱️ 12.02.2022):
...
<details><summary><b><a href="https://github.com/jupyter/qtconsole">qtconsole</a></b> (🥇31 ·  ⭐ 300) - Jupyter Qt Console. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 110 · 🔀 160 · 📦 95K · 📋 300 - 33% open · ⏱️ 25.02.2022):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 89 · 🔀 230 · 📦 2.9K · 📋 1.6K - 29% open · ⏱️ 09.03.2022):
...
- [GitHub](https://github.com/abhishekkrthakur/colabcode) (👨‍💻 8 · 🔀 220 · 📦 57 · 📋 68 - 54% open · ⏱️ 11.06.2021):

	```
	git clone https://github.com/abhishekkrthakur/colabcode
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 22K / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_console) (👨‍💻 58 · 🔀 120 · 📥 14 · 📋 140 - 40% open · ⏱️ 07.03.2022):
