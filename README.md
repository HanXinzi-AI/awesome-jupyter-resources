...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 610 · 🔀 3.7K · 📥 8.6K · 📦 9 · 📋 4.4K - 44% open · ⏱️ 21.07.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 280 · 🔀 1.7K · 📦 1.8K · 📋 2.1K - 5% open · ⏱️ 15.07.2022):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 520 · 📥 1.4M · 📋 1.7K - 9% open · ⏱️ 08.07.2022):
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 220 · 🔀 2.6K · 📋 760 - 5% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/googledatalab/datalab) (👨‍💻 52 · 🔀 250 · 📋 890 - 25% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/datalab) (📥 50K / month):
	```
	pip install datalab
	```
</details>
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 43 · 📥 790 · 📦 74 · 📋 110 - 3% open · ⏱️ 04.05.2022):
...
<details><summary><b><a href="https://github.com/microsoft/vscode-jupyter">VSCode Jupyter</a></b> (🥉16 ·  ⭐ 680) - VS Code Jupyter extension. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 200 · 🔀 820 · 📦 4.5K · 📋 1.8K - 31% open · ⏱️ 12.07.2022):
...
<details><summary><b><a href="https://github.com/plotly/jupyter-dash">jupyter-dash</a></b> (🥇28 ·  ⭐ 780) - Develop Dash apps in the Jupyter Notebook and JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 10 · 🔀 200 · 📥 77 · 📦 1.7K · 📋 58 - 62% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/plotly/jupyter-dash
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 460K / month):
	```
...
- [GitHub](https://github.com/maartenbreddels/ipywebrtc) (👨‍💻 9 · 🔀 33 · 📦 550 · 📋 51 - 60% open · ⏱️ 29.03.2021):

	```
	git clone https://github.com/maartenbreddels/ipywebrtc
	```
- [PyPi](https://pypi.org/project/ipywebrtc) (📥 72K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 350K · ⏱️ 04.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 890 / month):
	```
	npm install qgrid
	```
</details>
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 29 · 🔀 170 · 📦 20 · 📋 220 - 30% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 79K / month):
	```
...
- [GitHub](https://github.com/widgetti/ipyvuetify) (👨‍💻 10 · 🔀 44 · 📦 4 · 📋 170 - 26% open · ⏱️ 07.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 78K / month):
	```
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 21 · 🔀 58 · 📥 64 · 📋 180 - 43% open · ⏱️ 20.07.2022):

	```
	git clone https://github.com/InsightSoftwareConsortium/itkwidgets
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 8.1K / month):
	```
...
- [GitHub](https://github.com/mwouts/itables) (👨‍💻 3 · 🔀 27 · 📦 130 · 📋 44 - 9% open · ⏱️ 02.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/itables) (📥 8.7K / month):
	```
	pip install itables
	```
</details>
<details><summary><b><a href="https://github.com/PAIR-code/what-if-tool">What-If Tool</a></b> (🥉19 ·  ⭐ 700) - Source code/webpage/demos for the What-If Tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 550 · 📋 9 - 33% open · ⏱️ 19.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 89K / month):
	```
...
<details><summary><b><a href="https://github.com/spacetelescope/jdaviz">jdaviz</a></b> (🥉17 ·  ⭐ 66) - JWST astronomical data analysis tools in the Jupyter platform. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 8 · 📋 7 - 42% open · ⏱️ 14.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 840K / month):
	```
...
- [GitHub](https://github.com/nipy/niwidgets) (👨‍💻 16 · 🔀 33 · 📦 28 · 📋 34 - 50% open · ⏱️ 24.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/niwidgets) (📥 240 / month):
	```
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 23 · 🔀 250 · 📋 110 - 34% open · ⏱️ 19.07.2022):
...
- [PyPi](https://pypi.org/project/ipymaterialui) (📥 39 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-materialui) (📥 53 / month):
	```
...
- [PyPi](https://pypi.org/project/ipysigma) (📥 200 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 64 / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 3 · 🔀 10 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 23 / month):
	```
...
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 2.1K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 3K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 22 · 🔀 70 · 📥 57 · 📋 58 - 53% open · ⏱️ 06.07.2022):
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 64 · 🔀 110 · 📦 4 · 📋 150 - 38% open · ⏱️ 08.07.2022):
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 96 · 🔀 290 · 📥 15 · 📋 810 - 24% open · ⏱️ 20.07.2022):
...
- [GitHub](https://github.com/8080labs/pyforest) (👨‍💻 13 · 🔀 180 · 📋 23 - 39% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyforest) (📥 6.3K / month):
	```
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 24 · 🔀 23 · 📥 2 · 📦 1 · 📋 53 - 28% open · ⏱️ 21.07.2022):
...
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-rsession-proxy">Rsession Proxy</a></b> (🥉17 ·  ⭐ 91) - Jupyter extensions for running an RStudio rsession proxy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 20 · 🔀 66 · 📦 38 · 📋 71 - 36% open · ⏱️ 16.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/googlecolab/jupyter_http_over_ws) (👨‍💻 3 · 🔀 39 · 📋 29 - 72% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 58K / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 53 · 🔀 240 · 📦 3.3K · 📋 140 - 71% open · ⏱️ 12.06.2022):
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 57 · 🔀 380 · 📦 240 · 📋 400 - 31% open · ⏱️ 02.05.2022):
...
- [GitHub](https://github.com/gopherdata/gophernotes) (👨‍💻 29 · 🔀 220 · 📥 40 · 📦 8 · 📋 170 - 27% open · ⏱️ 08.07.2022):
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 300 · 📥 470 · 📋 410 - 51% open · ⏱️ 20.07.2022):
...
- [PyPi](https://pypi.org/project/ipykernel) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/anaconda/ipykernel) (📥 340K · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 30 · 🔀 77 · 📥 29 · 📋 140 - 19% open · ⏱️ 26.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 65K / month):
	```
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 15 · 🔀 140 · 📦 61 · 📋 230 - 22% open · ⏱️ 24.01.2022):
...
- [GitHub](https://github.com/IHaskell/IHaskell) (👨‍💻 110 · 🔀 240 · 📦 4 · 📋 740 - 4% open · ⏱️ 20.07.2022):
...
- [GitHub](https://github.com/SpencerPark/IJava) (👨‍💻 4 · 🔀 160 · 📥 86K · 📋 120 - 54% open · ⏱️ 08.12.2019):
...
- [GitHub](https://github.com/Anaconda-Platform/nb_conda_kernels) (👨‍💻 14 · 🔀 55 · 📋 130 - 26% open · ⏱️ 30.11.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nb_conda_kernels) (📥 660K · ⏱️ 14.02.2022):
	```
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 27 · 📦 85 · 📋 35 - 48% open · ⏱️ 20.09.2018):
...
- [PyPi](https://pypi.org/project/spylon-kernel) (📥 3.6K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spylon-kernel) (📥 92K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 44 · 🔀 110 · 📥 100 · 📋 180 - 7% open · ⏱️ 12.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 100 · 🔀 180 · 📥 19K · 📋 520 - 10% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 430 · 📋 2.1K - 2% open · ⏱️ 16.07.2022):
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 71 · 🔀 350 · 📦 3.1K · 📋 530 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 370K / month):
	```
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 60 · 🔀 410 · 📥 280 · 📦 7.1K · 📋 600 - 40% open · ⏱️ 21.07.2022):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 40K / month):
	```
	pip install voila
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 110 · 🔀 490 · 📋 1.1K - 40% open · ⏱️ 14.07.2022):

	```
	git clone https://github.com/executablebooks/jupyter-book
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 42K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 570K · ⏱️ 26.10.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 74K / month):
	```
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 67 · 🔀 650 · 📋 290 - 41% open · ⏱️ 13.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/knowledge-repo) (📥 360 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 84 · 🔀 320 · 📦 6 · 📋 630 - 28% open · ⏱️ 12.07.2022):
...
<details><summary><b><a href="https://github.com/nteract/commuter">commuter</a></b> (🥉15 ·  ⭐ 430) - Notebook sharing hub. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 70 · 🔀 340 · 📦 1.1K · 📋 390 - 19% open · ⏱️ 17.07.2022):

	```
	git clone https://github.com/fastai/nbdev
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 68K / month):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 33 · 🔀 44 · 📥 81 · 📦 62K · 📋 89 - 30% open · ⏱️ 05.07.2022):
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 120 · 🔀 230 · 📥 310 · 📋 320 - 43% open · ⏱️ 20.07.2022):
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 110 · 🔀 300 · 📦 160 · 📋 470 - 31% open · ⏱️ 08.07.2022):
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 19 · 📦 190 · 📋 49 - 2% open · ⏱️ 20.02.2022):
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 110 · 🔀 860 · 📋 330 - 15% open · ⏱️ 19.07.2022):
...
- [PyPi](https://pypi.org/project/ipyparallel) (📥 51K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipyparallel) (📥 640K · ⏱️ 21.06.2022):
	```
	conda install -c conda-forge ipyparallel
	```
</details>
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥉17 ·  ⭐ 520) - Run any standard Python code quality tool on a Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 20 · 🔀 31 · 📋 250 - 0% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbqa) (📥 33K / month):
	```
	pip install nbqa
	```
</details>
...
- [GitHub](https://github.com/QuantEcon/sphinxcontrib-jupyter) (👨‍💻 13 · 🔀 23 · 📦 26 · 📋 180 - 48% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinxcontrib-jupyter) (📥 830 / month):
	```
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 20 · 📦 55 · 📋 12 - 25% open · ⏱️ 04.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 6.6K / month):
	```
	pip install treon
	```
</details>
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 18 · 🔀 20 · 📦 3 · 📋 140 - 19% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/naas) (📥 5.3K / month):
	```
	pip install naas
	```
</details>
...
- [GitHub](https://github.com/stas00/ipyexperiments) (👨‍💻 3 · 🔀 11 · 📦 6 · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyexperiments) (📥 49 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 57 · 📦 250 · 📋 28 - 71% open · ⏱️ 19.05.2020):
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 63 · 📦 440 · 📋 65 - 61% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-latex) (👨‍💻 21 · 🔀 57 · 📦 2 · 📋 82 - 32% open · ⏱️ 12.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 25 · 🔀 67 · 📦 1 · 📋 100 - 29% open · ⏱️ 08.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 1K / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 22 · 📦 420 · 📋 23 - 30% open · ⏱️ 20.07.2022):

	```
	git clone https://github.com/telamonian/theme-darcula
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 1.2K / month):
	```
...
<details><summary><b><a href="https://github.com/Rahlir/theme-gruvbox">Gruvbox Theme</a></b> (🥉9 ·  ⭐ 47 · 💀) - Gruvbox dark theme for Jupyter Lab. Modeled on classic.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 51 · 🔀 250 · 📦 32 · 📋 1.5K - 15% open · ⏱️ 19.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/elyra) (📥 3.8K / month):
	```
	pip install elyra
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 7 · 🔀 29 · 📦 43 · 📋 41 - 51% open · ⏱️ 15.02.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-system-monitor) (📥 4.5K / month):
	```
	npm install jupyterlab-system-monitor
	```
</details>
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈18 ·  ⭐ 570) - A universal code formatter for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 36 · 🔀 45 · 📋 160 - 16% open · ⏱️ 16.07.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 30K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 4.1K / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 50 · 📦 4 · 📋 78 - 10% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/jwkvam/jupyterlab-vim) (👨‍💻 8 · 🔀 74 · 📦 3 · 📋 97 - 56% open · ⏱️ 16.07.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_vim) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 2K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-google-drive) (👨‍💻 16 · 🔀 70 · 📦 2 · 📋 98 - 33% open · ⏱️ 28.04.2022):

	```
	git clone https://github.com/jupyterlab/jupyterlab-google-drive
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/google-drive) (📥 750 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 15 · 📦 3 · 📋 66 - 6% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 5.7K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 7.9K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 8 · 🔀 14 · 📋 13 - 53% open · ⏱️ 17.01.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 220 / month):
	```
	npm install @jupyterlab/shortcutui
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥉13 ·  ⭐ 93) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-commenting">JupyterLab Commenting</a></b> (🥉13 ·  ⭐ 90 · 💀) - Commenting and annotation for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 10 · 🔀 20 · 📋 16 - 50% open · ⏱️ 01.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 2.1K / month):
	```
	pip install jupyterlab-sparkmonitor
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 69 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 5 · 🔀 9 · 📋 32 - 9% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 53 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 16 · 📋 110 - 27% open · ⏱️ 30.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 44 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 10 · 📥 77 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 46 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_email) (📥 30 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 30 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 1 · ⏱️ 07.12.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 4.7K / month):
	```
	npm install jupyterlab-topbar-extension
	```
</details>
<details><summary><b><a href="https://github.com/ReviewNB/jupyterlab-gitplus">jupyterlab-gitplus</a></b> (🥉8 ·  ⭐ 93 · 💤) - JupyterLab extension to create GitHub commits & pull.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/ReviewNB/jupyterlab-gitplus) (👨‍💻 2 · 🔀 7 · 📋 10 - 20% open · ⏱️ 06.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 29 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 15 · 🔀 41 · 📦 78 · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 52 · 📦 39 · 📋 92 - 25% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 4.9K / month):
	```
...
- [GitHub](https://github.com/ucphhpc/jhub-authenticators) (👨‍💻 5 · 🔀 1 · 📦 1 · ⏱️ 15.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jhub-authenticators) (📥 20 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 71 · 🔀 240 · 📦 110 · 📋 280 - 16% open · ⏱️ 12.07.2022):
...
- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 17 · 🔀 39 · 📦 20 · 📋 58 - 46% open · ⏱️ 22.04.2022):
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 9 · 📋 9 - 55% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 54 / month):
	```
...
<details><summary><b><a href="https://github.com/ipython/ipython">ipython</a></b> (🥇30 ·  ⭐ 15K) - Official repository for IPython itself. Other repos in the IPython.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/ipython/ipython) (👨‍💻 890 · 🔀 4.2K · 📥 320K · 📋 6.9K - 20% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 480 · 🔀 180 · 📥 400 · 📋 290 - 34% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 98 · 🔀 260 · 📦 3.7K · 📋 1.9K - 29% open · ⏱️ 20.07.2022):
...
- [GitHub](https://github.com/abhishekkrthakur/colabcode) (👨‍💻 8 · 🔀 240 · 📦 76 · 📋 73 - 56% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 18K / month):
	```
