...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 640 · 🔀 4.3K · 📥 16K · 📦 740 · 📋 4.8K - 41% open · ⏱️ 27.12.2023):
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 540 · 📥 1.5M · 📦 2 · 📋 1.7K - 9% open · ⏱️ 06.10.2023):

	```
	git clone https://github.com/nteract/nteract
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 700 / month):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 240 · 🔀 2.8K · 📦 21 · 📋 870 - 1% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 270 · 🔀 250 · 📦 2 · 📋 9.5K - 3% open · ⏱️ 24.12.2023):
...
- [GitHub](https://github.com/ydataai/ydata-profiling) (👨‍💻 120 · 🔀 1.6K · 📥 25 · 📦 2.1K · 📋 750 - 26% open · ⏱️ 15.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 620K / month):
	```
...
- [GitHub](https://github.com/quantopian/qgrid) (👨‍💻 30 · 🔀 410 · 📦 8 · 📋 280 - 55% open · ⏱️ 07.04.2020):
...
<details><summary><b><a href="https://github.com/medialab/ipysigma">ipysigma</a></b> (🥉19 ·  ⭐ 150) - A custom Jupyter widget library to display graphs using sigma.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/g2nb/igv-jupyter) (👨‍💻 5 · 🔀 14 · 📦 14 · ⏱️ 03.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/igv-jupyter) (📥 99 / month):
	```
...
- [GitHub](https://github.com/maartenbreddels/ipymaterialui) (👨‍💻 3 · 🔀 14 · 📦 7 · 📋 10 - 70% open · ⏱️ 29.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipymaterialui) (📥 14 / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 4 · 🔀 13 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 330 / month):
	```
...
- [GitHub](https://github.com/DGothrek/ipyaggrid) (👨‍💻 2 · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 7.1K / month):
	```
	pip install ipyaggrid
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 400 / month):
	```
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 4 · 🔀 2 · 📦 2 · 📋 24 - 33% open · ⏱️ 01.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 34 / month):
	```
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 4 · 🔀 41 · 📋 16 - 6% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 52 / month):
	```
	pip install py_d3
	```
</details>
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 67 · 🔀 97 · 📥 400 · 📋 1.5K - 59% open · ⏱️ 26.12.2023):
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 13 · 📦 7 · 📋 9 - 22% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 250 / month):
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 130 · 🔀 590 · 📦 12K · 📋 1.3K - 44% open · ⏱️ 05.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 92K / month):
	```
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 68 · 🔀 480 · 📥 1K · 📦 11K · 📋 700 - 39% open · ⏱️ 11.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/voila) (📥 57K / month):
	```
	pip install voila
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 42 · 🔀 42 · 📥 3.9K · 📦 19 · 📋 620 - 5% open · ⏱️ 27.12.2023):

	```
	git clone https://github.com/stencila/stencila
	```
- [NPM](https://www.npmjs.com/package/stencila) (📥 5 / month):
	```
...
- [GitHub](https://github.com/SamLau95/nbinteract) (👨‍💻 8 · 🔀 22 · 📦 3 · 📋 70 - 40% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbinteract) (📥 34K / month):
	```
...
<details><summary><b><a href="https://github.com/executablebooks/thebe">ThebeLab</a></b> (🥉15 ·  ⭐ 360) - ThebeLab: turning static HTML pages into live documents. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/stas00/ipyexperiments) (👨‍💻 3 · 🔀 11 · 📦 8 · ⏱️ 15.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipyexperiments) (📥 430 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 55 · 📦 580 · 📋 28 - 71% open · ⏱️ 19.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-dash) (📥 990 / month):
	```
...
- [GitHub](https://github.com/altair-viz/jupyterlab_voyager) (👨‍💻 6 · 🔀 35 · 📦 2 · 📋 60 - 66% open · ⏱️ 14.08.2019):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_voyager) (📥 22 / month):
	```
...
- [GitHub](https://github.com/yeebc/jupyterlab-neon-theme) (👨‍💻 4 · 🔀 8 · 📦 3 · 📋 13 - 15% open · ⏱️ 28.08.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@yeebc/jupyterlab_neon_theme) (📥 340 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-theme-toggle) (👨‍💻 2 · 🔀 3 · 📦 4 · 📋 5 - 20% open · ⏱️ 16.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-toggle) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/sidecar) (📥 6.9K / month):
	...
	pip install sidecar
	```
- [NPM](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-sidecar) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 8.5K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 15 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-hdf5) (👨‍💻 9 · 🔀 23 · 📦 2 · 📋 50 - 28% open · ⏱️ 11.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 380 / month):
	```
...
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥉14 ·  ⭐ 80) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/krassowski/jupyterlab-lsp) (👨‍💻 48 · 📦 25 · ⏱️ 06.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 2.8K / month):
	```
	npm install @krassowski/jupyterlab-lsp
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/gather">nbgather</a></b> (🥉13 ·  ⭐ 510 · 💀) - Spit shine for Jupyter notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/gather) (👨‍💻 13 · 🔀 32 · 📦 2 · 📋 27 - 33% open · ⏱️ 28.11.2022):

	```
	git clone https://github.com/microsoft/gather
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 20 / month):
	```
...
- [GitHub](https://github.com/pbugnion/jupyterlab-sql) (👨‍💻 2 · 🔀 48 · 📋 75 - 50% open · ⏱️ 04.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_sql) (📥 280 / month):
	```
...
- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 8 · 📋 32 - 31% open · ⏱️ 22.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 360 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 11 · 📥 99 · 📦 2 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 120 / month):
	```
...
- [GitHub](https://github.com/gavincyi/jupyterlab-executor) (👨‍💻 2 · 🔀 1 · 📥 4 · 📦 2 · 📋 3 - 33% open · ⏱️ 10.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-executor) (📥 420 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-bytecode) (👨‍💻 2 · 🔀 6 · 📦 2 · 📋 5 - 40% open · ⏱️ 16.10.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-bytecode) (📥 4 / month):
	```
...
- [GitHub](https://github.com/manuzhang/jupyterlab_spark) (👨‍💻 2 · 🔀 2 · 📦 2 · 📋 5 - 40% open · ⏱️ 05.09.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_spark) (📥 9 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 18 · 🔀 45 · 📦 100 · 📋 47 - 8% open · ⏱️ 26.12.2023):
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 7 · 🔀 22 · 📥 13 · 📋 32 - 53% open · ⏱️ 21.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 660 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 69 · 🔀 290 · 📦 180 · 📋 270 - 8% open · ⏱️ 21.11.2023):

	```
	git clone https://github.com/jupyterhub/dockerspawner
	```
- [PyPi](https://pypi.org/project/dockerspawner) (📥 23K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 84 · 🔀 280 · 📦 150 · 📋 350 - 20% open · ⏱️ 23.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 45K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 12 · 📋 11 - 63% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 120 / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 520 · 🔀 250 · 📥 2.5K · 📋 420 - 34% open · ⏱️ 23.12.2023):
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 30 · 🔀 46 · 📥 61 · 📋 41 - 26% open · ⏱️ 24.12.2023):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 150 · 🔀 400 · 📦 9.5K · 📋 3.1K - 28% open · ⏱️ 27.12.2023):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 630K / month):
	```
	pip install panel
	```
