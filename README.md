...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 560 · 🔀 3.3K · 📥 380 · 📦 110K · 📋 4.2K - 46% open · ⏱️ 03.06.2021):
...
- [GitHub](https://github.com/jupyterlab/jupyterlab) (👨‍💻 430 · 🔀 1.9K · 📦 43K · 📋 5.8K - 31% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 250 · 🔀 1.5K · 📦 1.4K · 📋 2K - 7% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 200 · 🔀 2.3K · 📋 650 - 8% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/ml-tooling/ml-workspace) (👨‍💻 9 · 🔀 250 · 📋 66 - 10% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 140 · 🔀 720 · 📋 260 - 5% open · ⏱️ 25.06.2021):
...
- [GitHub](https://github.com/ml-tooling/ml-hub) (👨‍💻 5 · 🔀 37 · 📥 1.3K · 📋 18 - 55% open · ⏱️ 02.10.2020):
...
<details><summary><b><a href="https://github.com/jupyterlab/retrolab">jupyterlab-classic</a></b> (🥉15 ·  ⭐ 150) - The next-gen old-school notebook UI. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 180 · 🔀 730 · 📦 1.9K · 📋 1.6K - 31% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/jupyter-widgets/ipywidgets
	```
- [PyPi](https://pypi.org/project/ipywidgets) (📥 9.4M / month):
	```
...
- [GitHub](https://github.com/pandas-profiling/pandas-profiling) (👨‍💻 79 · 🔀 1.1K · 📦 4.5K · 📋 470 - 14% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/pandas-profiling/pandas-profiling
	```
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 470K / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 67 · 🔀 280 · 📦 900 · 📋 420 - 37% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 44K / month):
	```
...
- [GitHub](https://github.com/PAIR-code/facets) (👨‍💻 28 · 🔀 810 · 📦 56 · 📋 150 - 49% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/facets-overview) (📥 92K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 300K · ⏱️ 20.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/man-group/dtale) (👨‍💻 15 · 🔀 190 · 📦 180 · 📋 380 - 10% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/dtale) (📥 11K / month):
	...
	pip install dtale
	```
- [Conda](https://anaconda.org/conda-forge/dtale) (📥 65K · ⏱️ 24.06.2021):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 13 · 🔀 36 · 📦 100 · 📋 89 - 34% open · ⏱️ 18.06.2021):
...
- [GitHub](https://github.com/mapbox/mapboxgl-jupyter) (👨‍💻 21 · 🔀 120 · 📦 110 · 📋 97 - 30% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mapboxgl) (📥 4.4K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 3 · 🔀 130 · 📥 58 · 📦 540 · 📋 40 - 67% open · ⏱️ 22.01.2021):
...
- [GitHub](https://github.com/mariobuikhuizen/ipyvuetify) (👨‍💻 10 · 🔀 34 · 📦 4 · 📋 120 - 42% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/mariobuikhuizen/ipyvuetify
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 29K / month):
	```
...
- [GitHub](https://github.com/maartenbreddels/ipywebrtc) (👨‍💻 9 · 🔀 31 · 📦 300 · 📋 46 - 56% open · ⏱️ 29.03.2021):

	```
	git clone https://github.com/maartenbreddels/ipywebrtc
	```
- [PyPi](https://pypi.org/project/ipywebrtc) (📥 26K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipywebrtc) (📥 200K · ⏱️ 29.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-webrtc) (📥 640 / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/pythreejs) (📥 310K · ⏱️ 02.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyter-threejs) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 8 · 🔀 53 · 📦 3 · 📋 110 - 55% open · ⏱️ 30.04.2020):
...
- [GitHub](https://github.com/pbugnion/gmaps) (👨‍💻 16 · 🔀 140 · 📦 1 · 📋 200 - 30% open · ⏱️ 22.07.2019):
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 10 · 🔀 44 · 📋 89 - 10% open · ⏱️ 09.06.2021):
...
- [GitHub](https://github.com/mariobuikhuizen/ipyvue) (👨‍💻 2 · 🔀 7 · 📦 16 · 📋 3 - 66% open · ⏱️ 22.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 28K / month):
	```
	pip install ipyvue
	```
...
<details><summary><b><a href="https://github.com/timkpaine/ipydagred3">ipydagred3</a></b> (🥉17 ·  ⭐ 25) - ipywidgets library for drawing directed acyclic graphs in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 6 · 📦 330 · 📋 8 - 37% open · ⏱️ 04.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 33K / month):
	```
	pip install ipydatawidgets
	```
- [Conda](https://anaconda.org/conda-forge/ipydatawidgets) (📥 93K · ⏱️ 06.01.2021):
	```
...
<details><summary><b><a href="https://github.com/QuantStack/ipytree">ipytree</a></b> (🥉15 ·  ⭐ 77) - A Tree Widget using Jupyter-widgets protocol and jsTree. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/maartenbreddels/ipymaterialui">ipymaterialui</a></b> (🥉14 ·  ⭐ 68 · 💀) - Jupyter Widgets based on React Material UI components. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 4 · 🔀 60 · 📦 7 · 📋 20 - 65% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 21 · 🔀 22 · 📋 350 - 54% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/ipysigma) (📥 95 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 38 / month):
	```
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 3 · 🔀 1 · 📦 1 · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 590 / month):
	```
...
<details><summary><b><a href="https://github.com/dunovank/jupyter-themes">Jupyter Themes</a></b> (🥇25 ·  ⭐ 8.6K · 📉) - Custom Jupyter Notebook Themes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dunovank/jupyter-themes) (👨‍💻 28 · 🔀 940 · 📦 2.3K · 📋 380 - 49% open · ⏱️ 26.04.2021):
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 15 · 🔀 56 · 📦 42 · 📋 51 - 50% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 21 · 🔀 49 · 📦 340 · 📋 92 - 35% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/jupyterhub/nbgitpuller
	```
- [PyPi](https://pypi.org/project/nbgitpuller) (📥 43K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 53 · 🔀 89 · 📦 1 · 📋 130 - 40% open · ⏱️ 15.06.2021):
...
- [GitHub](https://github.com/8080labs/pyforest) (👨‍💻 13 · 🔀 170 · 📋 21 - 38% open · ⏱️ 14.06.2021):
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 24 · 🔀 18 · 📥 1 · 📦 1 · 📋 47 - 25% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/Jupyter-contrib/jupyter_nbextensions_configurator) (👨‍💻 17 · 🔀 94 · 📋 79 - 59% open · ⏱️ 01.03.2020):
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 16 · 🔀 50 · 📦 25 · 📋 59 - 38% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/googlecolab/jupyter_http_over_ws) (👨‍💻 3 · 🔀 29 · 📋 25 - 72% open · ⏱️ 08.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 9.7K / month):
	```
...
- [GitHub](https://github.com/lspvic/jupyter_tensorboard) (👨‍💻 4 · 🔀 66 · 📋 66 - 57% open · ⏱️ 16.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-tensorboard) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyter_cms) (📥 200 / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_cms) (📥 64K · ⏱️ 15.10.2020):
	```
...
- [GitHub](https://github.com/thoth-station/jupyter-nbrequirements) (👨‍💻 12 · 🔀 5 · 📋 29 - 10% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/paypal/PPExtensions) (👨‍💻 9 · 🔀 25 · 📦 1 · 📋 38 - 42% open · ⏱️ 07.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/ppextensions) (📥 56 / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 44 · 🔀 220 · 📦 1.9K · 📋 130 - 71% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/catherinedevlin/ipython-sql
	```
- [PyPi](https://pypi.org/project/ipython-sql) (📥 62K / month):
	```
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 3 · 🔀 35 · 📋 16 - 12% open · ⏱️ 17.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 740 / month):
	```
	pip install py_d3
	```
</details>
...
- [GitHub](https://github.com/tmthyjames/SQLCell) (👨‍💻 14 · 🔀 9 · 📦 1 · 📋 84 - 71% open · ⏱️ 06.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/sqlcell) (📥 35 / month):
	```
	pip install sqlcell
	```
</details>
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 130 · 🔀 250 · 📦 120K · 📋 320 - 51% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 14 · 🔀 130 · 📦 50 · 📋 200 - 26% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/gibiansky/IHaskell) (👨‍💻 100 · 🔀 230 · 📦 4 · 📋 700 - 5% open · ⏱️ 11.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/ihaskell_jupyterlab) (📥 36 / month):
	```
...
<details><summary><b><a href="https://github.com/jupyter/enterprise_gateway">Enterprise Gateway</a></b> (🥈18 ·  ⭐ 440) - A lightweight, multi-tenant, scalable and secure.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyter/kernel_gateway) (👨‍💻 42 · 🔀 100 · 📥 81 · 📋 170 - 7% open · ⏱️ 08.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 69 · 📋 54 - 5% open · ⏱️ 11.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 960 / month):
	```
...
- [GitHub](https://github.com/vericast/spylon-kernel) (👨‍💻 6 · 🔀 23 · 📦 61 · 📋 34 - 47% open · ⏱️ 20.09.2018):
...
- [PyPi](https://pypi.org/project/spylon-kernel) (📥 3.9K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/spylon-kernel) (📥 70K · ⏱️ 05.10.2018):
	```
...
- [GitHub](https://github.com/clojupyter/clojupyter) (👨‍💻 23 · 🔀 74 · 📋 84 - 19% open · ⏱️ 25.01.2021):
...
- [GitHub](https://github.com/Calysto/matlab_kernel) (👨‍💻 17 · 🔀 71 · 📋 120 - 20% open · ⏱️ 09.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 910 / month):
	```
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 220 · 🔀 420 · 📦 110K · 📋 900 - 40% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 50 · 🔀 330 · 📦 4.2K · 📋 500 - 41% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 35K / month):
	```
	pip install voila
	```
- [Conda](https://anaconda.org/conda-forge/voila) (📥 130K · ⏱️ 28.04.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 79 · 🔀 330 · 📋 820 - 36% open · ⏱️ 30.06.2021):
...
<details><summary><b><a href="https://github.com/damianavila/RISE">RISE</a></b> (🥈23 ·  ⭐ 3K · 📉) - RISE: Live Reveal.js Jupyter/IPython Slideshow Extension. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 32 · 🔀 110 · 📦 49 · 📋 270 - 19% open · ⏱️ 24.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbdime) (📥 140K / month):
	```
	pip install nbdime
	```
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 330K · ⏱️ 25.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 75K / month):
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 21 · 🔀 32 · 📥 1.2K · 📦 16 · 📋 470 - 3% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 77 · 🔀 280 · 📦 5 · 📋 590 - 42% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 22 · 📦 40 · 📋 47 - 46% open · ⏱️ 28.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/nteract-scrapbook) (📥 67K / month):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 58 · 📦 3 · 📋 86 - 54% open · ⏱️ 11.05.2021):
...
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b> (🥉15 ·  ⭐ 65) - Use Jupyter Notebook in mkdocs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 7 · 🔀 8 · 📦 110 · 📋 25 - 16% open · ⏱️ 07.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 6.8K / month):
	```
	pip install mkdocs-jupyter
	```
</details>
<details><summary><b><a href="https://github.com/ideonate/cdsdashboards">cdsdashboards</a></b> (🥉14 ·  ⭐ 110) - JupyterHub extension for ContainDS Dashboards. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 96 · 🔀 250 · 📦 120 · 📋 430 - 32% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/ipython/ipyparallel) (👨‍💻 100 · 🔀 760 · 📦 1.6K · 📋 270 - 22% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/ipython/ipyparallel
	```
- [PyPi](https://pypi.org/project/ipyparallel) (📥 62K / month):
	```
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 26 · 🔀 36 · 📦 1.1K · 📋 91 - 34% open · ⏱️ 27.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/nbval) (📥 71K / month):
	```
	pip install nbval
	```
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 3 · 🔀 11 · 📦 100 · 📋 41 - 4% open · ⏱️ 29.06.2021):
...
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥉16 ·  ⭐ 240) - Run any standard Python code quality tool on a Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 12 · 🔀 13 · 📋 210 - 8% open · ⏱️ 25.06.2021):
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 18 · 📦 33 · 📋 11 - 18% open · ⏱️ 08.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 3.1K / month):
	```
	pip install treon
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyter-naas/naas">naas</a></b> (🥉12 ·  ⭐ 84) - Schedule notebooks, run them like APIs, expose securely your assets:.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/QuantStack/jupyterlab-drawio">JupyterLab Drawio</a></b> (🥈17 ·  ⭐ 470) - A standalone embedding of the FOSS drawio / mxgraph package.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 15 · 🔀 56 · 📦 11 · 📋 61 - 59% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/QuantStack/jupyterlab-drawio
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-drawio) (📥 6.4K / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 1.1K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/latex) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-chart-editor) (👨‍💻 5 · 🔀 18 · 📦 3 · 📋 31 - 38% open · ⏱️ 10.03.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-chart-editor) (📥 2.7K / month):
	```
...
<details><summary><b><a href="https://github.com/telamonian/theme-darcula">Darcula Theme</a></b> (🥇15 ·  ⭐ 100) - A handsome Darcula theme for Jupyterlab. The first jlab theme to.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 13 · 📦 3 · 📋 16 - 12% open · ⏱️ 20.06.2021):

	```
	git clone https://github.com/telamonian/theme-darcula
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 15K / month):
	```
...
<details><summary><b><a href="https://github.com/yeebc/jupyterlab-neon-theme">Neon Theme</a></b> (🥈12 ·  ⭐ 94) - A flat, 80's neon inspired theme for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-git">JupyterLab Git</a></b> (🥇26 ·  ⭐ 900) - A Git extension for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterlab/jupyterlab-git) (👨‍💻 62 · 🔀 180 · 📦 13 · 📋 460 - 16% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/jupyterlab/jupyterlab-git
	```
- [PyPi](https://pypi.org/project/jupyterlab-git) (📥 66K / month):
	```
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 64 · 🔀 360 · 📦 190 · 📋 410 - 12% open · ⏱️ 01.07.2021):
...
<details><summary><b><a href="https://github.com/jupyterlab/debugger">JupyterLab Debugger</a></b> (🥇24 ·  ⭐ 500) - A visual debugger for Jupyter notebooks, consoles, and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 34 · 📦 79 · 📋 260 - 6% open · ⏱️ 31.03.2021):
...
<details><summary><b><a href="https://github.com/elyra-ai/elyra">elyra</a></b> (🥇22 ·  ⭐ 950 · 📈) - Elyra extends JupyterLab Notebooks with an AI centric approach. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥇22 ·  ⭐ 950) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/krassowski/jupyterlab-lsp) (👨‍💻 33 · 🔀 74 · 📦 2 · 📋 330 - 33% open · ⏱️ 25.06.2021):

	```
	git clone https://github.com/krassowski/jupyterlab-lsp
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 26K / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 13 · 🔀 98 · 📦 95 · 📋 110 - 57% open · ⏱️ 18.06.2021):
...
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈18 ·  ⭐ 450) - A universal code formatter for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-github) (👨‍💻 12 · 🔀 72 · 📦 2 · 📋 57 - 40% open · ⏱️ 04.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-github) (📥 690 / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/dask-labextension) (📥 310K · ⏱️ 03.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/dask-labextension) (📥 6.8K / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 6 · 🔀 16 · 📦 1 · 📋 37 - 21% open · ⏱️ 12.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 4.2K / month):
	```
	npm install @ijmbarr/jupyterlab_spellchecker
	```
</details>
<details><summary><b><a href="https://github.com/timkpaine/jupyterlab_iframe">JupyterLab IFrame</a></b> (🥈16 ·  ⭐ 73) - JupyterLab iframe widget. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 4 · 🔀 13 · 📦 3 · 📋 61 - 8% open · ⏱️ 18.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 790 / month):
	```
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 15 · 🔀 29 · 📋 75 - 8% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 7 · 📥 54 · 📋 9 - 22% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/microsoft/gather) (👨‍💻 12 · 🔀 28 · 📋 26 - 38% open · ⏱️ 14.02.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/nbgather) (📥 96 / month):
	```
...
<details><summary><b><a href="https://github.com/parente/jupyterlab-quickopen">JupyterLab Quickopen</a></b> (🥉14 ·  ⭐ 67) - Quickly open a file in JupyterLab by typing part of its.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 560 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 570 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 8 · 🔀 14 · 📋 13 - 53% open · ⏱️ 17.01.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 800 / month):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 9 · 🔀 15 · 📋 21 - 9% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 6 · 📋 27 - 22% open · ⏱️ 22.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 5.1K / month):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥉13 ·  ⭐ 75) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 4 · 🔀 4 · 📋 23 - 43% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/jtpio/ipylab
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 210 / month):
	```
	pip install ipylab
	```
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab-kernelspy">JupyterLab Kernelspy</a></b> (🥉13 ·  ⭐ 58 · 📈) - A Jupyter Lab extension for inspecting messages.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉13 ·  ⭐ 52) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/nbcelltests) (📥 45 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_celltests) (📥 62 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (🔀 2 · 📋 35 - 14% open · ⏱️ 31.01.2021):
	...
	git clone https://github.com/timkpaine/jupyterlab_email
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-flake8) (📥 470 / month):
	```
...
<details><summary><b><a href="https://github.com/ReviewNB/jupyterlab-gitplus">jupyterlab-gitplus</a></b> (🥉10 ·  ⭐ 81) - JupyterLab extension to create GitHub commits & pull.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 260 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@reviewnb/jupyterlab_gitplus) (📥 460 / month):
	```
...
<details><summary><b><a href="https://github.com/gavincyi/jupyterlab-executor">jupyterlab-executor</a></b> (🥉10 ·  ⭐ 5) - JupyterLab extension to execute the scripts from the file.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 16 · 🔀 41 · 📦 27 · 📋 63 - 26% open · ⏱️ 10.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 4.1K / month):
	```
...
<details><summary><b><a href="https://github.com/mogthesprog/jwtauthenticator">JWT Authenticator</a></b> (🥉13 ·  ⭐ 34 · 💀) - A Token Authenticator for JupyterHub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mogthesprog/jwtauthenticator) (👨‍💻 7 · 🔀 34 · 📦 7 · 📋 15 - 46% open · ⏱️ 13.02.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-jwtauthenticator) (📥 150 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 38 · 🔀 87 · 📦 10 · 📋 110 - 36% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 770 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 14 · 🔀 32 · 📦 33 · 📋 34 - 44% open · ⏱️ 15.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 2K / month):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 810 · 🔀 4K · 📥 320K · 📦 210K · 📋 6.7K - 21% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 440 · 🔀 120 · 📥 62 · 📋 190 - 31% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 910K / month):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 18 · 🔀 33 · 📋 24 - 25% open · ⏱️ 25.06.2021):
...
- [GitHub](https://github.com/jupyter/qtconsole) (👨‍💻 110 · 🔀 160 · 📦 80K · 📋 280 - 32% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 70 · 🔀 180 · 📦 1.7K · 📋 1.2K - 26% open · ⏱️ 01.07.2021):
